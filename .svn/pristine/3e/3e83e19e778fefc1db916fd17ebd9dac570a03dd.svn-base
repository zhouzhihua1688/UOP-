...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/queryInfo.ajax', (req, res, next) => {
            ...
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/queryInfo.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/update.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/update.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/queryRecommendTp.ajax', (req, res, next) => {
            ...
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/queryRecommendTp.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/fresh.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/fresh.ajax',
                req: req,
                operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/viewList.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/viewList.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/homePgButtonConfig/channelMenu.ajax',
                req: req,
