...
new Vue({
    ...
    methods: {
        getGroup: function () {
            $.post({
                url: '/investmentMgmt/investmentStrategy/investFee/labels.ajax',
                data: {
                    type: '2'
                },
        ...
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/investmentMgmt/investmentStrategy/investFee/tableData.ajax',
                // data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        getParams: function (pmst, pmkey, targetArr) {
            ...
            $.post({
                url: '/investmentMgmt/investmentStrategy/investFee/params.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        add: function () {
            ...
            $.post({
                url: '/investmentMgmt/investmentStrategy/investFee/add.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        this.getTableData();
        ...
        modify: function () {
            ...
            console.log(params, 'params');
            $.post({
                url: '/investmentMgmt/investmentStrategy/investFee/modify.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        this.getTableData();
        ...
        deleteConfirm: function () {
            $.post({
                url: '/investmentMgmt/investmentStrategy/investFee/delete.ajax',
                data: {
                    code: this.deleteId
                },
                success: function (result) {
