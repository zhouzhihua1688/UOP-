...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/customerService/modifyPhoneNum/applyRecord/getList.ajax',
                data: params,
        ...
        widowsGoTo: function (appSerialId) {
            window.location.href = '/customerService/modifyPhoneNum/applyRecord.html?pageType=review&type=record&appSerialId=' + appSerialId;
        },
        //导出excel
        exportExcel: function () {
            ...
            var url = '/customerService/modifyPhoneNum/applyRecord/exportExcel.ajax?invnm=' + this.invnm + '&idNo=' + this.idNo + '&mobielNo=' + this.mobielNo + '&appStatus=' + this.appStatus + '&startDate=' + this.startDate + '&endDate=' + this.endDate;
            window.location.href = url;
        },
    },
    filters: {
        appStatusText: function (value) {
            if (value === '0') {
                return '待经办';
            } else if (value === '2') {
                return '经办不通过';
