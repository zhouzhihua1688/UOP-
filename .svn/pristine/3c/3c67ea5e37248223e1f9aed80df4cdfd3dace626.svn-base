    ...
    methods: {
        ...
        add: function () {
            ...
            var params = {
                ...
                privilegeTotalCount: this.privilegeTotalCount,
        ...
        downloadFile: function () {
            var str = "privilegeId,custNo,receiveTime,expireTime,privilegeSourceId,privilegeTotalCount\n" +
                "001VIPDA,1004274299,2019-04-12 00:00:00,2019-04-12 17:58:46,3,10\n";
            var uri = 'data:text/csv;charset=utf-8,' + encodeURIComponent(str);
            var link = document.createElement("a");
            link.href = uri;
            link.download = "示例模板.csv";
