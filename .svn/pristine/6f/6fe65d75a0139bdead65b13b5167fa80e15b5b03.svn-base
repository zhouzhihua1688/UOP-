...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/queryInfo.ajax', (req, res, next) => {
					if (req.body.channelId) {
						...
						let option = {
							pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/queryInfo.ajax',
							req: req,
						...
						let getChannelList = new Promise((resolve, reject) => {
							let option = {
								pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/queryInfo.ajax ---getOneChannel',
								req: req,
						...
						getChannelList.then((result) => {
							...
							if (firstChannel) {
								...
								params.pageNo = parseInt(params.pageNo);
								params.pageSize = parseInt(params.pageSize);
								!params.weProdId&&(params.channelId = firstChannel);
								let userId = req.session.loginInfo.userid;
								let option = {
									pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/queryInfo.ajax',
									req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/enable.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/enable.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/add.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/update.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/update.ajax',
            req: req,
            operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/fresh.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/fresh.ajax',
                req: req,
                operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/viewList.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/viewList.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/appletProductRecommend/channelMenu.ajax',
                req: req,
                url: apiUrlList.channelMenu,
                qs: req.body,
                timeout: 15000,
