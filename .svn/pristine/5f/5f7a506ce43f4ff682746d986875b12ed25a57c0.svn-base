...
module.exports = function (app) {
    app.get('/contentMgmt/:menu/:page', (req, res, next) => {
        let channel = 'contentMgmt';
    ...
    app.get('/contentMgmt/:menu', (req, res, next) => {
    ...
    require('./productMaterial')(app);
    require('./productData')(app);
    require('./tagMgmt')(app);
    require('./contentClassifyMgmt')(app);
    require('./operationMaterial')(app);
    require('./serviceAndRemindMgmt')(app);
    require('./addRichRemind')(app);
};
