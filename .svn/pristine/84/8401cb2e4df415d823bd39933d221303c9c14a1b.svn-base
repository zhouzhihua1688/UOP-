...
module.exports = function (app) {
    ...
    app.post('/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax', (req, res, next) => {
        ...
        let custTypeList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax  --custTypeList',
                req,
        ...
        let tradeTypeList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax --tradeTypeList',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let branchCodeList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax --branchCodeList',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'SYSTEM',
        ...
        let channelList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax --channelList',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let fundList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax --fundList',
                req,
        ...
        let groupList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getDialogList.ajax --groupList',
                req,
                // url: apiUrl.translate,
                // qs: {
                //     pmst: 'SYSTEM',
    ...
    app.post('/businessMgmt/businessParamConfig/discountHandle/getServiceList.ajax', (req, res, next) => {
        ...
        let custTypeTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getServiceList.ajax --custTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let tradeTypeTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getServiceList.ajax --tradeTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let branchCodeTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getServiceList.ajax --branchCodeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'SYSTEM',
        ...
        let channelTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getServiceList.ajax --channelTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let getTableData = new Promise((resolve, reject) => {
            ...
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getServiceList.ajax --getTableData',
                req,
    ...
    app.post('/businessMgmt/businessParamConfig/discountHandle/getLocalList.ajax', (req, res, next) => {
        ...
        let custTypeTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getLocalList.ajax --custTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let tradeTypeTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getLocalList.ajax --tradeTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let branchCodeTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getLocalList.ajax --branchCodeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'SYSTEM',
        ...
        let channelTranslate = new Promise((resolve, reject) => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfig/discountHandle/getLocalList.ajax --channelTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
