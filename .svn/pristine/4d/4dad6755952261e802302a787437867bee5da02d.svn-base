...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/queryInfo.ajax', (req, res, next) => {
					if (req.body.channelId) {
						...
						let option = {
							pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/queryInfo.ajax',
							req: req,
						...
						let getChannelList = new Promise((resolve, reject) => {
							let option = {
								pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/queryInfo.ajax ---getOneChannel',
								req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/update.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/update.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/adviceDisplayStyle.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/adviceDisplayStyle.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/adviceTpListQuery.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/adviceTpListQuery.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/fresh.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/fresh.ajax',
                req: req,
                operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/viewList.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/viewList.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/informationContentConfig/channelMenu.ajax',
                req: req,
                url: apiUrlList.channelMenu,
                qs: req.body,
                timeout: 15000,
