...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            this.currentIndex= 0;
            $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/getTableData.ajax',
                data: params,
        ...
        //   params.tagid=this.tagid
          ...
          $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/saveParam.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        $("#info").click(function(){
        ...
        update:function(){
          ...
          if(tagNameList.indexOf(params.tagnm.toString()) != -1){
           ...
           $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/update.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        $("#info").click(function(){
        ...
        deleteParam:function(){
           ...
           params.tagId=this.tagid;
            $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/deleteParam.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        // _this.getTableData(0);
        ...
        attribute:function(item){
            ...
            params.tagVersion= 1; //新标签系统
             $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/attribute.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        getChannelList: function(){
            ...
            var params = {};
            $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/queryChannel.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        AddList:function(){
           ...
           if(tagdescList.indexOf(params.tagdesc.toString()) != -1){
            ...
            if (!params.channel) {
                _this.showDialog('putAdd', 'info', true, '渠道来源不能为空');
                return false;
            }
            $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/AddList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0);
        ...
        modify:function(item){
           ...
           this.channelName= this.channelList.filter(function (sub) {
            return sub.channel.indexOf(item.channel) > -1;
        })[0].channelName
        ...
        modifyUpdate:function(){
          ...
          if(tagdescList.indexOf(params.tagdesc.toString()) != -1){
           ...
           $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/modifyUpdate.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0);
        ...
        deleteList:function(){
           ...
           console.log(params)
           $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/deleteList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0);
        ...
        deleteAll:function(){
            ...
            console.log(params)
            $.post({
                url: '/businessMgmt/fundTag/fundTagMgmtNew/deleteAll.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0);
        ...
        exportAll:function(){
                var _this = this;
                var url;
                url = '/businessMgmt/fundTag/fundTagMgmtNew/exportAll.ajax'
