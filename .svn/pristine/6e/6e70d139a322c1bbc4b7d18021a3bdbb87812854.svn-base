...
const apiUrlList = require('../apiConfig').fundTag.fundTagSettingNew;
...
module.exports = function (app) {
    // 获取初始数据和查询
    app.post('/businessMgmt/fundTag/fundTagSettingNew/getTableData.ajax', (req, res, next) => {
        let params = {};
        var fundId = req.body.fundId
        // req.body.fundId && (params.fundId = req.body.fundId);
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/getTableData.ajax',
            req,
    ...
    //批量删除数据
    app.post('/businessMgmt/fundTag/fundTagSettingNew/deleteParam.ajax', (req, res, next) => {
        let params = {};
        req.body.fundIds && (params.fundIds = JSON.parse(req.body.fundIds));
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/deleteParam.ajax',
            req,
    ...
    //新增基金标签数据
    app.post('/businessMgmt/fundTag/fundTagSettingNew/saveBatch.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/saveBatch.ajax',
            req,
    ...
    //导入
    app.post('/businessMgmt/fundTag/fundTagSettingNew/upload.ajax', (req, res, next) => {
        ...
        form.parse(req, (err, fields, files) => {
            ...
            try {
                ...
                let option = {
                    pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/upload.ajax',
                    req,
                    url: apiUrlList.saveBatch,
                    body: sendData,
                    timeout: 60000,
    ...
    //修改数据
    app.post('/businessMgmt/fundTag/fundTagSettingNew/update.ajax', (req, res, next) => {
        let params = {};
        req.body.fundid && (params.fundid = req.body.fundid);
        ...
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/update.ajax',
            req,
    ...
    // 导出全量
    app.get('/businessMgmt/fundTag/fundTagSettingNew/exportAll.ajax', (req, res, next) => {
        let params = {};
        params.tagVersion = 1;
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/exportAll.ajax',
            req,
    ...
    // 获取新增弹窗里基金代码一级菜单名称
    app.post('/businessMgmt/fundTag/fundTagSettingNew/getTagName.ajax', (req, res, next) => {
        let params = {};
        req.body.pageNum && (params.pageNum = req.body.pageNum);
        req.body.pageSize && (params.pageSize = req.body.pageSize);
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNewNew/getTagName.ajax',
            req,
    ...
    // 获取新增弹窗里基金代码e二级菜单名称
    app.post('/businessMgmt/fundTag/fundTagSettingNew/getDescName.ajax', (req, res, next) => {
        // let params = {};
        var tagId = req.body.tagId;
        let option = {
            pageUrl: '/businessMgmt/fundTag/fundTagSettingNew/getDescName.ajax',
            req,
