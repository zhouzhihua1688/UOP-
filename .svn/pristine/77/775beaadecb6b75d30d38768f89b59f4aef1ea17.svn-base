new Vue({
    ...
    methods: {
        ...
        search: function() {
            ...
            params.key = this.key;
            $.post({
                url: '/publicConfig/appSearchConfig/synonymConfig/query.ajax',
                data: params,
        ...
        checkDiaData: function() {
            if (this.dialog_item === '') {
                this.showDialog('operate', 'info', true, '请填写要添加的近义词');
                return false;
            }
            return true;
        },
        add: function() {
            ...
            var url = '/publicConfig/appSearchConfig/synonymConfig/add.ajax';
            if(this.updateId){
                params.id = this.updateId;
                url = '/publicConfig/appSearchConfig/synonymConfig/update.ajax';
            }
            $.post({
                url: url,
                data: params,
        ...
        deleteData: function() {
            var _this = this;
            $.post({
                url: '/publicConfig/appSearchConfig/synonymConfig/del.ajax',
                data: {
                    id: this.deleteId
                },
                success: function(result) {
