...
const apiUrl = require('../apiConfig').businessParamConfigOC.discountReview;
const tableName = 'bm_bpcoc_discount';
const requestForSchedule = require('request');
const scheduleMe = require('../../schedule');
...
const init = {
    ...
    menuId: '9-1-2',
    urlList: apiUrl.userList,
    urlDetail: apiUrl.userDetail,
    urlEmail: apiUrl.emailUrl,
    urlSms: apiUrl.smsUrl,
    urlIsWorkDay: apiUrl.isWorkDay,
    urlNatural: apiUrl.naturalDayForWorkDay,
    urlCloseCheck: apiUrl.closeCheck,
    request: requestForSchedule,
    ruleKey: 'UOP001',
    emailContent: '请进入统一运营平台，业务管理--业务参数配置_营运--折扣复核 页面进行复核http://172.16.8.166:8039/businessMgmt/businessParamConfigOC/discountReview.html',
    emailSubject: '[UOP]您还有折扣经办数据待复核，请及时复核，以免影响收市清算！',
    hour: 15,
    minute: 15,
    second: 0
};
...
module.exports = function (app) {
    // 获取下拉列表数据
    app.post('/businessMgmt/businessParamConfigOC/discountReview/getDialogList.ajax', (req, res, next) => {
        // 获取交易类型翻译
        let tradeTypeList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getDialogList.ajax --tradeTypeList',
                req,
        ...
        let channelList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getDialogList.ajax --channelList',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let fundList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getDialogList.ajax --fundList',
                req,
        ...
        let custTypeList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getDialogList.ajax --custTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let groupList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getDialogList.ajax --groupList',
                req,
    ...
    // 获取本地数据
    app.post('/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax', (req, res, next) => {
        // 获取客户类型翻译
        let custTypeTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax --custTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let tradeTypeTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax --tradeTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let branchCodeTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax --branchCodeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'SYSTEM',
        ...
        let channelTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax --channelTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let getTableData = new Promise((resolve, reject) => {
            pool.getConnection(function (error, connection) {
                if (error) {
                    console.log('/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax 链接本地数据库失败', error.message);
                    reject({
                        error: '链接本地数据库失败'
                    });
                }
                ...
                console.log('/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax run SQL: ', SQL);
                connection.query(SQL, function (error, results) {
                    console.log('/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax run SQL error', error);
                    console.log('/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax run SQL results:', results);
                    connection.release();
                    if (error) {
                        reject({
                            error: '运行SQL语句失败'
        ...
        let getServiceData = new Promise(resolve => {
            ...
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getLocalList.ajax --getServiceData',
                req,
    ...
    // 获取查询服务端数据
    app.post('/businessMgmt/businessParamConfigOC/discountReview/getServiceList.ajax', (req, res, next) => {
        // 获取客户类型翻译
        let custTypeTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getServiceList.ajax --custTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let tradeTypeTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getServiceList.ajax --tradeTypeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let branchCodeTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getServiceList.ajax --branchCodeTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'SYSTEM',
        ...
        let channelTranslate = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getServiceList.ajax --channelTranslate',
                req,
                url: apiUrl.translate,
                qs: {
                    pmst: 'COMMONSERVICE',
        ...
        let getTableData = new Promise((resolve, reject) => {
            ...
            params.pageSize = 999999999;
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/getServiceList.ajax --getTableData',
                req,
                url: apiUrl.getTableData,
                qs: params,
                timeout: 15000,
    ...
    // 驳回
    app.post('/businessMgmt/businessParamConfigOC/discountReview/reviewReject.ajax', (req, res, next) => {
        ...
        pool.getConnection(function (error, connection) {
            if (error) {
                console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewReject.ajax 链接本地数据库失败', error.message);
                return res.send({
                    error: 1,
                    msg: '链接本地数据库失败',
                    data: null
            ...
            console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewReject.ajax run business SQL:', SQL);
            connection.query(SQL, function (error, results) {
                console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewReject.ajax run business SQL error:', error);
                console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewReject.ajax run business SQL results:', results);
                connection.release();
                if (error) {
                    return res.send({
                        error: 1,
    ...
    // 通过
    app.post('/businessMgmt/businessParamConfigOC/discountReview/reviewAccept.ajax', (req, res, next) => {
        if (req.body.creator === req.session.loginInfo.userid && !req.session.loginInfo.isAdmin) {
            return res.send({
                error: 1,
                msg: '禁止复核自己提交的申请',
        ...
        pool.getConnection(function (error, connection) {
            if (error) {
                console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewAccept.ajax 链接本地数据库失败', error.message);
                return res.send({
                    error: 1,
                    msg: '链接本地数据库失败',
                    data: null
            ...
            let checkHasSubmit = new Promise((resolve, reject) => {
                ...
                console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewAccept.ajax run check SQL: ', SQL);
                connection.query(SQL, function (error, results) {
                    console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewAccept.ajax run check SQL error: ', error);
                    console.log('/businessMgmt/businessParamConfigOC/discountReview/reviewAccept.ajax run check SQL results: ', results);
                    if (error) {
                        reject({
            ...
            let operateService = function (item) {
                return new Promise((resolve, reject) => {
                    ...
                    let option = {
                        pageUrl: '/businessMgmt/businessParamConfigOC/discountReview/reviewAccept.ajax',
                        req,
