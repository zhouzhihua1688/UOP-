...
const apiUrlList = require('../apiConfig').investmentStrategy.targetProfitStrategyConfig;
const investTableName = 'uop_log_invest';
const baseUrl = '/investmentMgmt/investmentStrategy/targetProfitStrategyConfig'
