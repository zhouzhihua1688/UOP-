...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/queryInfo.ajax', (req, res, next) => {
					if (req.body.channelId) {
						...
						let option = {
							pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/queryInfo.ajax',
							req: req,
						...
						let getChannelList = new Promise((resolve, reject) => {
							let option = {
								pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/queryInfo.ajax ---getOneChannel',
								req: req,
						...
						getChannelList.then((result) => {
							...
							if (firstChannel) {
								...
								params.pageNo = parseInt(params.pageNo);
								params.pageSize = parseInt(params.pageSize);
								!params.indexConfigId&&(params.channelId = firstChannel);
								let userId = req.session.loginInfo.userid;
								let option = {
									pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/queryInfo.ajax',
									req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/enable.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/enable.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/update.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/update.ajax',
            req: req,
            operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/fresh.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/fresh.ajax',
                req: req,
                operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/viewList.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/viewList.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/thermalIndexConfig/channelMenu.ajax',
                req: req,
                url: apiUrlList.channelMenu,
                qs: req.body,
                timeout: 15000,
