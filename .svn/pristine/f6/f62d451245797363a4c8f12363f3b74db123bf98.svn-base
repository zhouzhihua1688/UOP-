new Vue({
    ...
    methods: {
        ...
        getFundIdList: function () {
            var _this = this;
            $.post({
                url: '/businessMgmt/IPOMgmtOCReview/datumRate/fundIdList.ajax ',
        ...
        getTableData: function () {
            ...
            $.post({
                url: '/businessMgmt/IPOMgmtOCReview/datumRate/tableData.ajax ',
                data: params,
                success: function (result) {
        ...
        review: function () {
            ...
            $.post({
                url: '/businessMgmt/IPOMgmtOCReview/datumRate/review.ajax ',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
                        this.getTableData()
