new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/awardMgmt/awardSetting/typeSetting/getTableData.ajax',
                data: params,
        ...
        setAddData: function (obj) {
            this.diaTypeNm = obj.typeNm ? obj.typeNm : '';
            this.diaTypeDesc = obj.typeDesc ? obj.typeDesc : '';
        ...
        deleteData: function () {
            var _this = this;
            $.post({
                url: '/awardMgmt/awardSetting/typeSetting/delete.ajax',
        ...
        diaInfoCheck: function () {
            if (!this.diaTypeNm) {
                this.showDialog('add', 'info', true, '奖励类型名称不能为空');
                return false;
            }
            return true;
        },
        add: function () {
            ...
            if (this.diaInfoCheck()) {
                var params = {};
                params.typeNm = this.diaTypeNm;
                params.typeDesc = this.diaTypeDesc;
                params.remark = this.diaRemark;
                this.isUpdate && (params.id = this.updateId);
                var url = '/awardMgmt/awardSetting/typeSetting/';
