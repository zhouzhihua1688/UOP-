...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendViewMgmt/contentTypeMgmt/queryInfo.ajax', (req, res, next) => {
            ...
            let option = {
                pageUrl: '/recommendSystem/recommendViewMgmt/contentTypeMgmt/queryInfo.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendViewMgmt/contentTypeMgmt/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendViewMgmt/contentTypeMgmt/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendViewMgmt/contentTypeMgmt/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendViewMgmt/contentTypeMgmt/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendViewMgmt/contentTypeMgmt/update.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendViewMgmt/contentTypeMgmt/update.ajax',
            req: req,
