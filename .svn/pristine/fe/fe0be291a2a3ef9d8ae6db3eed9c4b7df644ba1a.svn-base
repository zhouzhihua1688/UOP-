new Vue({
    ...
    methods: {
        ...
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/automatedOperation/systemConfig/triggerModeConfig/queryInfo.ajax',
                data: params,
        ...
        add: function () {
            ...
            this.isUpdate && (params.id = this.updateId)&& (params.modifyBy = this.userId);
            !this.isUpdate && (params.createBy = this.userId);
            var url = '/automatedOperation/systemConfig/triggerModeConfig/';
        ...
        deleteConfirm:function(){
            var _this = this;
            $.post({
                url: '/automatedOperation/systemConfig/triggerModeConfig/delete.ajax',
