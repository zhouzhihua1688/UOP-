...
module.exports = function (app) {
    ...
    app.post('/businessMgmt/IPOMgmtEC/fundChangeHandle/collection.ajax', (req, res, next) => {
        ...
        let params = req.body;
        let option = {
            pageUrl: '/businessMgmt/IPOMgmtEC/fundChangeHandle/collection.ajax',
            req,
    ...
    app.post('/businessMgmt/IPOMgmtEC/fundChangeHandle/getLineList.ajax', (req, res, next) => {
        ...
        let userId = req.session.loginInfo.userid;
        let option = {
            pageUrl: '/businessMgmt/IPOMgmtEC/fundChangeHandle/getLineList.ajax',
            req,
    ...
    app.post('/businessMgmt/IPOMgmtEC/fundChangeHandle/submit.ajax', (req, res, next) => {
        ...
        pool.getConnection(function (err, connection) {
            ...
            connection.query(`UPDATE ${tableName} SET ? WHERE delete_flag='F'&&local_id=${params.local_id}&&update_timestamp='${params.update_timestamp}';`, {
                operator: userid,
                status: 2
            }, function (err, data) {
                connection.release()
    ...
    app.post('/businessMgmt/IPOMgmtEC/fundChangeHandle/add.ajax', (req, res, next) => {
        ...
        new Promise(function (resolve, reject) {
            let option = {
                pageUrl: '/businessMgmt/IPOMgmtEC/fundChangeHandle/add.ajax',
                req,
                url: `${apiUrl.getLineList}${params.fundid}/convert/query`,
                timeout: 15000,
                json: true
