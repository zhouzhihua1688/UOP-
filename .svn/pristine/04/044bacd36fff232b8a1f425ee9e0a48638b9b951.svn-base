new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            // }
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/getTableData.ajax',
                data: params,
        ...
        getTagName: function () {
            ...
            var params = {};
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/getTagName.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        tagList: function (tagItem,id) {
            ...
            obj.fundList2 = [];
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/getDescName.ajax',
        ...
        saveParam: function () {
            ...
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/saveBatch.ajax',
                data: {
        ...
        update: function () {
            ...
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/update.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        deleteParam: function () {
            ...
            console.log(params)
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/deleteParam.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        setTimeout(function () {
        ...
        exportAll: function () {
            ...
            var _this = this;
            var url;
            url = '/businessMgmt/fundTag/fundTagSetting/exportAll.ajax'
        ...
        upload: function () {
            ...
            $.post({
                url: '/businessMgmt/fundTag/fundTagSetting/upload.ajax',
                data: formData,
