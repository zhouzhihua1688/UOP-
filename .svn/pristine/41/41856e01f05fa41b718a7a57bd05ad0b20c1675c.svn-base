    ...
    methods: {
        ...
        configMgmt:function(){
            ...
            for (var j = 0; j < this.tableData.length; j++) {
                if (this.tableData[j].check) {
                    ...
                    this.tableData[j].typeKey='wap_advice';
            ...
            if(!window.localStorage){
                ...
                var url="/recommendSystem/recommendSystemConfigMgmt/positionTheThemeMgmt.html?pageType=Modify&contentTp=wap_advice&channelId="+channelIds[0]
                storage.setItem("wap_advice",JSON.stringify(ids));
                window.open(url);
            }
        ...
        configThis:function(item){
            ...
            if(!window.localStorage){
                ...
                var storage=window.localStorage;
                var url="/recommendSystem/recommendSystemConfigMgmt/positionTheThemeMgmt.html?pageType=Modify&contentTp=wap_advice&channelId="+channelIds+'&objconfigId='+ids[0].objconfigId;
                storage.setItem("wap_advice",JSON.stringify(ids));
                window.open(url);
            }
        },
