(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $("<input/>", {type: "hidden", id: "hourHidden", name: "hourHidden"}).appendTo(hourlyTab);
            ...
            $("<input/>", {type: "hidden", id: "dayHidden", name: "dayHidden"}).appendTo(dailyTab);
            ...
            $("<input/>", {type: "hidden", id: "monthHidden", name: "monthHidden"}).appendTo(monthlyTab);
            ...
            $(weeklyTab).append('<div class="imp weekList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="MON">Mon<input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="TUE">Tue<input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="WED">Wed<input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="THU">Thu<input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="FRI">Fri<input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="SAT">Sat<input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="SUN">Sun</div>');

            $("<input/>", {type: "hidden", id: "weekHidden", name: "weekHidden"}).appendTo(weeklyTab);
            ...
            var $i = $("<input>", {
                type: 'text',
                placeholder: 'cron表达式...'
            }).addClass("cronValue").val($(that).val());
            $i.appendTo($g);
            // Add the button
            var $b = $("<button class=\"btn btn-primary btn-sm\"><i class=\"fa fa-edit\"></i></button>");
            // Put button inside span
            var $s = $("<span style='width: auto;'>").addClass("input-group-btn");
            $b.appendTo($s);
            $s.appendTo($g);
    ...
    $.fn.cronGen.tools = {
        ...
        cronParse: function (cronExpress) {
            ...
            if (cronExpress) {
                ...
                $("input[name=hourHidden]").val(regs[0]);
                $("input[name=dayHidden]").val(regs[1]);
                $("input[name=monthHidden]").val(regs[2]);
                $("input[name=weekHidden]").val(regs[3]);

                $.fn.cronGen.tools.initObj(regs[0], "hour");
                $.fn.cronGen.tools.initDay(regs[1]);
                $.fn.cronGen.tools.initMonth(regs[2]);
                $.fn.cronGen.tools.initWeek(regs[3]);
            }
        },
        cronResult: function () {
            var result;
