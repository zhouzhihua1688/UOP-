new Vue({
    ...
    methods: {
        ...
        fundList:function(){
            var _this = this;
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/fundList.ajax',
        ...
        tradeTypeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/tradeTypeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        channelTypeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/channelTypeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        //         console.log(params)
        //         $.post({
        //             url: '/businessMgmt/businessParamConfigOC/quotaReview/getTableData.ajax',
        //             data: params,
        //             success: function (result) {
        //                 if (result.error === 0) {
        ...
        getServiceData: function (currentIndex, type) {
            ...
            if (type== 0) {
                ...
                params.pageSize = this.pageMaxNum;
                $.post({
                    url: '/businessMgmt/businessParamConfigOC/quotaReview/getServiceData.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
                            // _this.tableData = result.data;
        ...
        saveParam: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/saveParam.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        update: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/update.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0, this.type);
        ...
        deleteUser: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/deleteParam.ajax',
                // data: {ids: ids.join(',')},
                data: params,
                traditional: true,
                success: function (result) {
        ...
        reviewPass: function (item) {
            ...
            if (this.type == 1) {
                ...
                if (params.operate!=1) {
                    console.log("有数据")
                    $.post({
                        url: '/businessMgmt/businessParamConfigOC/quotaReview/reviewPass.ajax',
                        data: params,
                        success: function (result) {
                            if (result.error === 0) {
                    ...
                    console.log("无数据")
                    $.post({
                        url: '/businessMgmt/businessParamConfigOC/quotaReview/SavePass.ajax',
                        data: params,
                        success: function (result) {
                            if (result.error === 0) {
                                _this.getTableData(0, params.type);
        ...
        reviewReject: function (item) {
            ...
            console.log(params)
            $.post({
                url: '/businessMgmt/businessParamConfigOC/quotaReview/reviewReject.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0, params.type);
