new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/marketingActive/activeTemplateMgmt/activeCut/getList.ajax',
                data: params,
        ...
        add: function () {
            ...
            var _this = this;
            $.post({
                url: '/marketingActive/activeTemplateMgmt/activeCut/dataAdd.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        deleteData: function (id) {
            ...
            var _this = this;
            $.post({
                url: '/marketingActive/activeTemplateMgmt/activeCut/dataDelete.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        showView: function (id) {
            ...
            $.post({
                url: '/marketingActive/activeTemplateMgmt/activeCut/dataQuery.ajax',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
        ...
        changeDate: function () {
            ...
            var _this = this;
            $.post({
                url: '/marketingActive/activeTemplateMgmt/activeCut/dataChange.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
