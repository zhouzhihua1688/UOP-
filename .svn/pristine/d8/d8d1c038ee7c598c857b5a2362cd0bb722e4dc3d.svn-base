...
const apiUrlList = require('../apiConfig').fundComparison.rateHandle;
module.exports = function (app) {
    // 获取初始数据和查询
    app.post('/businessMgmt/fundComparison/rateHandle/getTableData.ajax', (req, res, next) => {
        let params = {};
        req.body.fundIdList && (params.fundIdList = req.body.fundIdList);
        let option = {
            pageUrl: '/businessMgmt/fundComparison/rateHandle/getTableData.ajax',
            req,
