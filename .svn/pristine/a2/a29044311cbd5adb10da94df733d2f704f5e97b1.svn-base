...
const filePathExternalReal = apiConfig.filePathExternal + '/productMaterialMgmt/productList';
const filePathExternalBak = apiConfig.filePathExternal + '/productMaterialMgmt/productList/bak';
const filePathExternal_url = apiConfig.filePafilePathExternalthUrl + '/productMaterialMgmt/productList';//返回给前端的路径
