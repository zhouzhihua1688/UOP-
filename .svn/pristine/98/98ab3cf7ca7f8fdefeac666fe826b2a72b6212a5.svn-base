...
var vm = new Vue({
    ...
    mounted: function () {
        ...
        // 获取渠道
        $.post({
            url:'/contentMgmt/operationMaterial/pictureMgmt/getbranchList.ajax',
    ...
    methods: {
        getTagAll:function(){
           ...
           var _this=this;
            $.post({
                url:'/contentMgmt/operationMaterial/pictureMgmt/getTagAll.ajax',
                data:{
                    parentCategoryId:''
                },
                success: function (result) {
    ...
    // 获取基金列表
        fundList:function(){
            var _this = this;
            $.post({
                url: '/contentMgmt/operationMaterial/pictureMgmt/fundList.ajax',
                success: function (result) {
                    if (result.error === 0) {
...
// 获取基金经理列表 
        getManagerList: function() {
            var _this = this;
            $.post({
                url: '/contentMgmt/operationMaterial/pictureMgmt/getManagerList.ajax',
                success: function(result) {
                    if (result.error === 0) {
 ...
 // 主页面数据
        ...
        getTableData: function (currentIndex) {
            ...
            _this.tableData=[];
            $.post({
                url: '/contentMgmt/operationMaterial/pictureMgmt/getTableData.ajax',
                data: params,
                success: function (result) {
                    $(".cover").hide();
                    if (result.error === 0) {
        ...
        getThemeList:function(mediaIdList){
            ...
            console.log(params);
            $.post({
                    url: '/contentMgmt/operationMaterial/pictureMgmt/getThemeList.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
...
// 确认删除图片
        ...
        //   params.publishTime="20220421"; 
          ...
          let url='';
          if(!_this.updateId){
             url='/contentMgmt/operationMaterial/pictureMgmt/add.ajax'
          }else{
              params.mediaId=_this.updateId;
             url='/contentMgmt/operationMaterial/pictureMgmt/update.ajax'
          }
            $.post({
                url:url,
                data:params,
...
// start-现有材料相关操作--弹窗
        ...
        chooseMaterialId:function(materialId,num){
            ...
            console.log(params);
            $.post({
                url: '/contentMgmt/operationMaterial/pictureMgmt/threeClassifyList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        console.log(result)
        ...
        searchMaterial:function(currentIndex){
            var _this=this;
                ...
                $.post({
                    url: '/contentMgmt/operationMaterial/pictureMgmt/searchMaterial.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
                            if(currentIndex){
       ...
       // start-用mediaId调取details数据获取分类id和关联标签的回显
          ...
          console.log(params);
          $.post({
              url: '/contentMgmt/operationMaterial/pictureMgmt/getUpdateDetails.ajax',
              data: params,
              success: function (result) {
                  if (result.error === 0) {
...
//start-- 修改数据
        ...
        showUpdate:function (item) {
            ...
            _this.updateTime=item.modifyTime?item.modifyTime.substr(0,15):'';
...
//start-删除数据
        ...
        del:function(){
            ...
            console.log(params);
            $.post({
                url: '/contentMgmt/operationMaterial/pictureMgmt/del.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        setTimeout(function(){
...
//end-删除数据
    ...
    //    一级标签
        getTagList:function(){
            ...
            var params={}
            $.post({
                url:'/contentMgmt/operationMaterial/pictureMgmt/getTagList.ajax',
                // data:params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        getSecondTagList:function(tagCategoryId,i){
            ...
            console.log(params);
            $.post({
                url:'/contentMgmt/operationMaterial/pictureMgmt/getSecondTagList.ajax',
                data:params,
                success: function (result) {
                    if (result.error === 0) {
                        console.log(result);
        ...
        uploadsFile(e) {
            ...
            $(".cover").show();
            $.post({
                url: '/contentMgmt/operationMaterial/pictureMgmt/uploadFile.ajax',
                type: 'post',
                dataType: 'json',
                data: formdata,
                processData: false,
        ...
        uploadImg:function(e){
            ...
            var reader = new FileReader()
                ...
                reader.onload = (e) => {
                    ...
                    $.post({
                        url: '/contentMgmt/operationMaterial/pictureMgmt/uploadImg.ajax',
