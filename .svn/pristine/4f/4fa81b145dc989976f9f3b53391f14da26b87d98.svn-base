new Vue({
    ...
    mounted: function () {
        ...
        $('#msgCenter').css('width', '200px').select2({
            allowClear: true
        })
        $.fn.modal.Constructor.prototype.enforceFocus = function () {};
        // 消息中心list
        $.post({
            url: '/awardMgmt/awardSetting/cardSetting/msgRuleList.ajax',
            data: {
                ruleSource: 'reward',
                pageNo: '1',
                pageSize: '9999'
    ...
    methods: {
        ...
        setAddData: function (obj) {
            ...
            $("#msgCenter").val(obj.msgConfigId ? obj.msgConfigId : '').trigger('change');  //新增消息20220621
        ...
        add: function () {
            ...
            if (this.diaInfoCheck()) {
                ...
                params.msgConfigId=$("#msgCenter").val();   //新增消息20220621
