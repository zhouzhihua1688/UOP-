...
module.exports = function (app) {
    ...
    app.post('/automatedOperation/reachContentMgmt/reachMannerConfig/searchList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/automatedOperation/reachContentMgmt/reachMannerConfig/searchList.ajax',
            req: req,
    ...
    app.post('/automatedOperation/reachContentMgmt/reachMannerConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/automatedOperation/reachContentMgmt/reachMannerConfig/add.ajax',
            req: req,
    ...
    app.post('/automatedOperation/reachContentMgmt/reachMannerConfig/update.ajax', (req, res, next) => {
        ...
        let option = {
            session: req.session,
            pageUrl: '/automatedOperation/reachContentMgmt/reachMannerConfig/update.ajax',
            req: req,
