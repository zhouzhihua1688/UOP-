...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/queryInfo.ajax', (req, res, next) => {
					if (req.body.channelId) {
						...
						let option = {
							pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/queryInfo.ajax',
							req: req,
						...
						let getChannelList = new Promise((resolve, reject) => {
							let option = {
								pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/queryInfo.ajax ---getOneChannel',
								req: req,
						...
						getChannelList.then((result) => {
							...
							if (firstChannel) {
								...
								params.pageNo = parseInt(params.pageNo);
								params.pageSize = parseInt(params.pageSize);
								!params.tagConfigId&&(params.channelId = firstChannel);
								let userId = req.session.loginInfo.userid;
								let option = {
									pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/queryInfo.ajax',
									req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/enable.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/enable.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/update.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/update.ajax',
            req: req,
            operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/querychildContentTp.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/querychildContentTp.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/querychildContentIds.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/querychildContentIds.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/fresh.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/fresh.ajax',
                req: req,
                operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/viewList.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/viewList.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/channelMenu.ajax',
                req: req,
                url: apiUrlList.channelMenu,
                qs: req.body,
                timeout: 15000,
    ...
    //获取所有视图列表---标签关联内容ID
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/getInfoId.ajax', (req, res, next) => {
            let params = req.body;
            params.pageNo=parseInt(params.pageNo);
            params.pageSize=parseInt(params.pageSize);
            let userId= req.session.loginInfo.userid;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/getInfoId.ajax',
                req: req,
                url: apiUrlList.getInfoId,
                qs: params,
                timeout: 15000,
                json: true
            };
    ...
    //上传图片
    app.post('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/upload1.ajax', (req, res, next) => {
        ...
        form.parse(req, (err, fields, files) => {
            ...
            console.log('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/upload1.ajax:', option);
            request.post(option, (error, response, body) => {
                console.log('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/upload1.ajax error:', error);
                console.log('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/upload1.ajax statusCode:', response && response.statusCode);
                console.log('/recommendSystem/recommendSystemTemplateConfig/labelTemplateConfig/upload1.ajax body:', body);
                if (error) {
