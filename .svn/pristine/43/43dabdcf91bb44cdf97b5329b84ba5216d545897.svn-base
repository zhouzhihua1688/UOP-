new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            params.fundAcco = this.qFundAcco;
        ...
        submitFirst: function () {
            ...
            (this.checkFlg=='F')&&(params.checkComment = this.rejectCause1);
            (this.checkFlg=='Y')&&(params.checkComment = '');
            params.accptMd = "EC";
        ...
        submitSecond: function () {
            ...
            params.checker = this.userId;
            (this.checkFlg2=='F')&&( params.checkComment = this.rejectCause2);
            (this.checkFlg2=='Y')&&( params.checkComment = '');
            params.accptMd = "EC";
            ...
            $.post({
                ...
                success: function (result) {
                    if (result.error === 0) {
                        ...
                        // _this.rejectCause1 = result.data.checkComment;
                        var formatTime1 = result.data.pqiAssetEndDt ? result.data.pqiAssetEndDt.split('').slice(0, 4).join('') + '-' + result.data.pqiAssetEndDt.split('').slice(4, 6).join('') + '-' + result.data.pqiAssetEndDt.split('').slice(6, 8).join('') : '';
                            ...
                            $.post({
                                ...
                                success: function (result) {
                                    if (result.error === 0) {
                                        ...
                                        // _this.rejectCause2 = result.data.checkComment;
                                        var formatTime2 = result.data.pqiAssetEndDt ? result.data.pqiAssetEndDt.split('').slice(0, 4).join('') + '-' + result.data.pqiAssetEndDt.split('').slice(4, 6).join('') + '-' + result.data.pqiAssetEndDt.split('').slice(6, 8).join('') : '';
        ...
        exportExcel: function () {
            ...
            url = '/businessMgmt/highFinancialMgmt/investAudit/exportExcel.ajax?appStrDt=' + startTime + '&appEndDt=' + endTime + '&checkDt=' + checkDt + '&idNo=' + this.qIdNo + '&checkFlg=' + this.qCheckFlg + '&fundAcco=' + this.qFundAcco;;
