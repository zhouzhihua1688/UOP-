...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/queryInfo.ajax', (req, res, next) => {
			if (req.body.channelId) {
				...
				let option = {
					pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/queryInfo.ajax',
					req: req,
				...
				let getChannelList = new Promise((resolve, reject) => {
					let option = {
						pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/queryInfo.ajax ---getOneChannel',
						req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/update.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/update.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/fresh.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/fresh.ajax',
                req: req,
                operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/viewList.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/viewList.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/channelMenu.ajax',
                req: req,
                url: apiUrlList.channelMenu,
                qs: req.body,
                timeout: 15000,
