...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            params.tradeAcco =this.tradeAcco;
            params.status =this.status;
            params.startDate=this.$refs.insertTimestamp.value
            params.endDate=this.$refs.updateTimestamp.value
            params.pageNum = currentIndex + 1;
            params.pageSize = this.pageMaxNum;
            $.post({
                url: '/businessMgmt/highFinancialMgmt/custCareQry/getTableData.ajax',
                data: params,
        ...
        fundList:function(currentIndex){
            ...
            $.post({
                url: '/businessMgmt/highFinancialMgmt/custCareQry/fundList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
