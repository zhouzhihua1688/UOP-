new Vue({
    ...
    methods: {
        ...
        getFundIdList: function () {
            $.post({
                url: '/businessMgmt/IPOMgmtOCReview/transferBlacklist/fundIdNameList.ajax ',
        ...
        getTableData: function () {
            ...
            $.post({
                url: '/businessMgmt/IPOMgmtOCReview/transferBlacklist/tableData.ajax ',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
        ...
        addSave: function() {
			...
			var _this = this;
			$.post({
				url: '/businessMgmt/IPOMgmtOCReview/transferBlacklist' + url,
				data: params,
				success: function(result) {
					if (result.error === 0) {
		...
		deleteData: function() {
            ...
            params.importFundid = this.importFundid_dialog;
			$.post({
				url: '/businessMgmt/IPOMgmtOCReview/transferBlacklist/delete.ajax',
