...
module.exports = function (app) {
    ...
    app.post('/marketingActive/activeRun/activeRoad/getList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/marketingActive/activeRun/activeRoad/getList.ajax',
            req,
            url: apiUrl.dataList,
            qs: params,
            timeout: 15000,
    ...
    app.post('/marketingActive/activeRun/activeRoad/dataAdd.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeRun/activeRoad/dataAdd.ajax',
            req,
            url: apiUrl.dataAdd,
            body: params,
            timeout: 15000,
    ...
    app.post('/marketingActive/activeRun/activeRoad/dataChange.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeRun/activeRoad/dataChange.ajax',
            req,
    ...
    app.post('/marketingActive/activeRun/activeRoad/dataDelete.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeRun/activeRoad/dataDelete.ajax',
            req,
    ...
    app.post('/marketingActive/activeRun/activeRoad/dataQuery.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeRun/activeRoad/dataQuery.ajax',
            req,
