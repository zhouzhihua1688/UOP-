new Vue({
    ...
    mounted: function () {
        ...
        $.post({
            url: '/marketingActive/activeRun/activeAward/activeAll.ajax',
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/marketingActive/activeRun/activeAward/getList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        add: function () {
            ...
            console.log(params)
            $.post({
                url: '/marketingActive/activeRun/activeAward/dataAdd.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        deleteData: function () {
            ...
            var _this = this;
            $.post({
                url: '/marketingActive/activeRun/activeAward/dataDelete.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        showView: function (id) {
            ...
            $.post({
                url: '/marketingActive/activeRun/activeAward/dataQuery.ajax',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
        ...
        changeDate: function () {
            ...
            var _this = this;
            $.post({
                url: '/marketingActive/activeRun/activeAward/dataChange.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        fileUpload: function (item) {
            ...
            $.ajaxFileUpload({
                url: '/marketingActive/activeRun/activeAward/ExcelUpload.ajax',
                type: 'POST',
                dataType: 'json',
                data: {
                    awardsPkgName: this.awardsPkgName
