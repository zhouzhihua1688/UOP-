new Vue({
    ...
    methods: {
        ...
        getTableData: function (currentIndex) {
            ...
            params.triggerTargetName = this.triggerTargetName;
            params.targetTypeDesc = this.targetTypeDesc;
            // console.log(params);
            _this.loadingStatus = '数据获取中...';
            $.post({
                url: '/automatedOperation/reachContentMgmt/reachMannerConfig/searchList.ajax',
                data: params,
        ...
        setAddData: function (obj) {
            this.diatriggerTargetName = obj.triggerTargetName ? obj.triggerTargetName : '';
            this.diatargetTypeDesc = obj.targetTypeDesc ? obj.targetTypeDesc : '';
        ...
        add: function () {
            if (this.diatriggerTargetName == '') {
                this.showDialog('add', 'info', true, '名称必须填写！');
                return false;
            }
            if (this.diatargetTypeDesc == '') {
                this.showDialog('add', 'info', true, '描述必须填写！');
                return false;
            }
            if (this.diatriggerTargetType == '') {
                this.showDialog('add', 'info', true, '类型必须填写！');
                return false;
            }
            var _this = this;
            var params = {};
            params.targetTypeDesc = this.diatargetTypeDesc;
            params.triggerTargetName = this.diatriggerTargetName;
            ...
            var url = '/automatedOperation/reachContentMgmt/reachMannerConfig/';
