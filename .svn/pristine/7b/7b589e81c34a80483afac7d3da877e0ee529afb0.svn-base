...
module.exports = {
    ...
    experienceGold: {
        ...
        rewardSetting: {
            ...
            configList: `${experienceGold}/experien-coupon-param/query-by-page`,
        },
        rewardQuery: {
        ...
        sendMgmt: {
            send: `${experienceGold}/experience-coupon/batch-send`,
            getList: `${experienceGold}/experience-coupon/query-by-page`,
        }
    },
};