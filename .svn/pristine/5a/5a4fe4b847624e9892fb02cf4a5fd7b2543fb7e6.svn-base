...
module.exports = function (app) {
    ...
    app.post('/marketingActive/taskManage/rulePlaceholders/getList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/marketingActive/taskManage/rulePlaceholders/getList.ajax',
            req,
            url: apiUrl.dataList,
            qs: params,
            timeout: 15000,
    ...
    app.post('/marketingActive/taskManage/rulePlaceholders/placeholdersQuery.ajax', (req, res, next) => {
        let params = req.body,
            userName = req.session.loginInfo.username;
        let option = {
            pageUrl: '/marketingActive/taskManage/rulePlaceholders/placeholdersQuery.ajax',
            req,
    ...
    app.post('/marketingActive/taskManage/rulePlaceholders/dataAdd.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/taskManage/rulePlaceholders/dataAdd.ajax',
            req,
            url: apiUrl.dataAdd,
            body: params,
            timeout: 15000,
    ...
    app.post('/marketingActive/taskManage/rulePlaceholders/dataChange.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/taskManage/rulePlaceholders/dataChange.ajax',
            req,
    ...
    app.post('/marketingActive/taskManage/rulePlaceholders/dataDelete.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/taskManage/rulePlaceholders/dataDelete.ajax',
            req,
