...
module.exports = function (app) {
    app.get('/recommendSystem/:menu/:page', (req, res, next) => {
        let channel = 'recommendSystem';
    ...
    app.get('/recommendSystem/:menu', (req, res, next) => {
    ...
    require('./recommendSystemConfigMgmt')(app);
    require('./recommendSystemTemplateConfig')(app);
    require('./recommendSystemGroupMgmt')(app);
    require('./recommendViewMgmt')(app);
};
