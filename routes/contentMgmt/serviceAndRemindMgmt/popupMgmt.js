...
module.exports = function (app) {
    ...
    // 查询单个弹窗信息
    app.post('/contentMgmt/serviceAndRemindMgmt/popupMgmt/searchSingle.ajax', (req, res, next) => {
        let params = {};
        params.materiaIdList = req.body.materiaIdList;
        let option = {
            pageUrl: '/contentMgmt/serviceAndRemindMgmt/popupMgmt/searchSingle.ajax',
            req,
            // operateType: 3, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
            url: apiUrlList.searchSingle,
            qs: params,
            timeout: 15000,
            json: true
        };
    ...
    // 文章列表修改发布的状态-开关
    app.post('/contentMgmt/serviceAndRemindMgmt/popupMgmt/switchUpdate.ajax', (req, res, next) => {
        let params = {};
        params.id = req.body.id;
        params.enableFlag = req.body.enableFlag;
        let option = {
            pageUrl: '/contentMgmt/serviceAndRemindMgmt/popupMgmt/switchUpdate.ajax',
            req,
            url: apiUrlList.switchUpdate,
            qs: params,
            timeout: 15000,
