...
const apiUrlList = require('../apiConfig').operationMaterial.addRichSign;
const baseUrl = '/contentMgmt/operationMaterial/addRichSign';
const fs = require('fs');
const path = require('path');
const formidable = require('formidable');
const apiConfig = require('../apiConfig');
const filePathExternal = apiConfig.filePathExternal + '/operationMaterial';
const filePathExternalReal = apiConfig.filePathExternal + '/operationMaterial/addRichSign';
const filePathExternalBak = apiConfig.filePathExternal + '/operationMaterial/addRichSign/bak';
const filePathExternal_url = apiConfig.filePafilePathExternalthUrl + '/operationMaterial/addRichSign';//返回给前端的路径
module.exports = function (app) {
    // 获取初始主页面数据和查询
    app.post('/contentMgmt/operationMaterial/addRichSign/getTableData.ajax', (req, res, next) => {
        // let params = {};
        let params = req.body;
        ...
        console.log("------------",params);
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/getTableData.ajax',
            req,
    ...
    // 删除
    app.post('/contentMgmt/operationMaterial/addRichSign/del.ajax', (req, res, next) => {
        let params = {};
        params.mediaId = req.body.mediaId;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/del.ajax',
            req,
    ...
    // 获取一二级分类
    app.post('/contentMgmt/operationMaterial/addRichSign/classifyList.ajax', (req, res, next) => {
        let params = {};
        // console.log("------------",params)
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/classifyList.ajax',
            req,
    ...
    // 获取三级分类
    app.post('/contentMgmt/operationMaterial/addRichSign/threeClassifyList.ajax', (req, res, next) => {
        let params = {};
        params.parentCategoryId=req.body.parentCategoryId;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/threeClassifyList.ajax',
            req,
    ...
    app.post('/contentMgmt/operationMaterial/addRichSign/getTagAll.ajax', (req, res, next) => {
       
        new Promise(function (resolve, reject) {
            let params = {};
            let option = {
                pageUrl: '/contentMgmt/operationMaterial/addRichSign/getTagAll.ajax',
                req,
                    ...
                    arr.forEach(function(item){
                          item.categoryConfigList.filter(function(secondTag){
                            // return secondTag.categoryName=='内部投资策略';
                             if(secondTag.categoryName=='添富日签'){  //获取内部投资策略的
    ...
    // 获取新增里面关联标签
    app.post('/contentMgmt/operationMaterial/addRichSign/getTagList.ajax', (req, res, next) => {
        let params = {};
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/getTagList.ajax',
            req,
     ...
     // 获取新增里面关联标签-二级
     app.post('/contentMgmt/operationMaterial/addRichSign/getSecondTagList.ajax', (req, res, next) => {
        let params = {};
        params.tagCategoryId=req.body.tagCategoryId;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/getSecondTagList.ajax',
            req,
    ...
    // 获取基金列表
    app.post('/contentMgmt/operationMaterial/addRichSign/fundList.ajax', (req, res, next) => {
        let params = {};
        params.pageNum = '1';
        params.pageSize = '99';
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/fundList.ajax',
            req,
    ...
    // 获取基金经理
    app.post('/contentMgmt/operationMaterial/addRichSign/getManagerList.ajax', (req, res, next) => {
        let params = {};
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/getManagerList.ajax',
            req,
    ...
    // 获取修改的details
    app.post('/contentMgmt/operationMaterial/addRichSign/getUpdateDetails.ajax', (req, res, next) => {
        let params = {};
        params.materiaIdList =req.body.materiaIdList;
        console.log(params);
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/getUpdateDetails.ajax',
            req,
    ...
    //获取现有材料数据
    app.post('/contentMgmt/operationMaterial/addRichSign/searchMaterial.ajax', (req, res, next) => {
        // let params = {};
        let params = req.body;
        // params.categoryId =req.body.categoryId; 
        console.log("------------",params);
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/searchMaterial.ajax',
            req,
    ...
    // 上传材料
    app.post('/contentMgmt/operationMaterial/addRichSign/uploadFile.ajax', (req, res, next) => {
        try {
            ...
            console.log('/contentMgmt/operationMaterial/addRichSign/uploadFile.ajax -------- 文件上传失败error:', error);
                res.send({
                        error: 0,
                        msg: '上传失败',
                        data: null
    ...
    // 上传图片
    app.post('/contentMgmt/operationMaterial/addRichSign/uploadImg.ajax', (req, res, next) => {
        try {
            !fs.existsSync(apiConfig.filePathExternal) && fs.mkdirSync(apiConfig.filePathExternal);
            !fs.existsSync(filePathExternal) && fs.mkdirSync(filePathExternal);
            !fs.existsSync(filePathExternalReal) && fs.mkdirSync(filePathExternalReal);
            ...
            console.log('/contentMgmt/operationMaterial/addRichSign/uploadImg.ajax -------- 文件上传失败error:', error);
                res.send({
                        error: 0,
                        msg: '上传失败',
                        data: null
    ...
    //上架状态-开关
    app.post('/contentMgmt/operationMaterial/addRichSign/updatePushStatus.ajax', (req, res, next) => {
        let params = {};
        params.mediaId = Number(req.body.mediaId);
        params.pushStatus = req.body.pushStatus;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/addRichSign/updatePushStatus.ajax',
            req,
            url: apiUrlList.updatePushStatus,
            body: params,
            timeout: 15000,
            json: true
        };
