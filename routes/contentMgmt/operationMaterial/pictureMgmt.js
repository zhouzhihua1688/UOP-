...
const apiUrlList = require('../apiConfig').operationMaterial.pictureMgmt;
const baseUrl = '/contentMgmt/operationMaterial/pictureMgmt';
const fs = require('fs');
const path = require('path');
const formidable = require('formidable');
const apiConfig = require('../apiConfig');
const filePathExternal = apiConfig.filePathExternal + '/operationMaterial';
const filePathExternalReal = apiConfig.filePathExternal + '/operationMaterial/pictureMgmt';
const filePathExternalBak = apiConfig.filePathExternal + '/operationMaterial/pictureMgmt/bak';
const filePathExternal_url = apiConfig.filePafilePathExternalthUrl + '/operationMaterial/pictureMgmt';//返回给前端的路径
module.exports = function (app) {
    // 获取初始主页面数据和查询
    app.post('/contentMgmt/operationMaterial/pictureMgmt/getTableData.ajax', (req, res, next) => {
        // let params = {};
        let params = req.body;
        ...
        console.log("------------",params);
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getTableData.ajax',
            req,
     ...
     // 获取材料主题字段的名字
     app.post('/contentMgmt/operationMaterial/pictureMgmt/getThemeList.ajax', (req, res, next) => {
        // let params = {};
        let params = req.body;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getThemeList.ajax',
            req,
    ...
    // 删除
    app.post('/contentMgmt/operationMaterial/pictureMgmt/del.ajax', (req, res, next) => {
        let params = {};
        params.mediaId = req.body.mediaId;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/del.ajax',
            req,
    ...
    // 获取一二级分类
    app.post('/contentMgmt/operationMaterial/pictureMgmt/classifyList.ajax', (req, res, next) => {
        let params = {};
        // console.log("------------",params)
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/classifyList.ajax',
            req,
    ...
    // 获取三级分类
    app.post('/contentMgmt/operationMaterial/pictureMgmt/threeClassifyList.ajax', (req, res, next) => {
        let params = {};
        params.parentCategoryId=req.body.parentCategoryId;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/threeClassifyList.ajax',
            req,
    ...
    app.post('/contentMgmt/operationMaterial/pictureMgmt/getTagAll.ajax', (req, res, next) => {
       
        new Promise(function (resolve, reject) {
            let params = {};
            let option = {
                pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getTagAll.ajax',
                req,
                    ...
                    arr.forEach(function(item){
                          item.categoryConfigList.filter(function(secondTag){
                            // return secondTag.categoryName=='投教专区';
                             if(secondTag.categoryName=='图片管理'){  //获取投教专区的
    ...
    // 获取新增里面关联标签
    app.post('/contentMgmt/operationMaterial/pictureMgmt/getTagList.ajax', (req, res, next) => {
        let params = {};
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getTagList.ajax',
            req,
     ...
     // 获取新增里面关联标签-二级
     app.post('/contentMgmt/operationMaterial/pictureMgmt/getSecondTagList.ajax', (req, res, next) => {
        let params = {};
        params.tagCategoryId=req.body.tagCategoryId;
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getSecondTagList.ajax',
            req,
    ...
    // 获取基金列表
    app.post('/contentMgmt/operationMaterial/pictureMgmt/fundList.ajax', (req, res, next) => {
        let params = {};
        params.pageNum = '1';
        params.pageSize = '99';
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/fundList.ajax',
            req,
    ...
    // 获取基金经理
    app.post('/contentMgmt/operationMaterial/pictureMgmt/getManagerList.ajax', (req, res, next) => {
        let params = {};
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getManagerList.ajax',
            req,
    ...
    // 获取修改的details
    app.post('/contentMgmt/operationMaterial/pictureMgmt/getUpdateDetails.ajax', (req, res, next) => {
        let params = {};
        params.materiaIdList =req.body.materiaIdList;
        console.log(params);
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/getUpdateDetails.ajax',
            req,
    ...
    //获取现有材料数据
    app.post('/contentMgmt/operationMaterial/pictureMgmt/searchMaterial.ajax', (req, res, next) => {
        // let params = {};
        let params = req.body;
        // params.categoryId =req.body.categoryId; 
        console.log("------------",params);
        let option = {
            pageUrl: '/contentMgmt/operationMaterial/pictureMgmt/searchMaterial.ajax',
            req,
    ...
    // 上传材料
    app.post('/contentMgmt/operationMaterial/pictureMgmt/uploadFile.ajax', (req, res, next) => {
        try {
            ...
            console.log('/contentMgmt/operationMaterial/pictureMgmt/uploadFile.ajax -------- 文件上传失败error:', error);
                res.send({
                        error: 0,
                        msg: '上传失败',
                        data: null
    ...
    // 上传图片
    app.post('/contentMgmt/operationMaterial/pictureMgmt/uploadImg.ajax', (req, res, next) => {
        try {
            !fs.existsSync(apiConfig.filePathExternal) && fs.mkdirSync(apiConfig.filePathExternal);
            !fs.existsSync(filePathExternal) && fs.mkdirSync(filePathExternal);
            !fs.existsSync(filePathExternalReal) && fs.mkdirSync(filePathExternalReal);
            ...
            console.log('/contentMgmt/operationMaterial/pictureMgmt/uploadImg.ajax -------- 文件上传失败error:', error);
                res.send({
                        error: 0,
                        msg: '上传失败',
                        data: null
