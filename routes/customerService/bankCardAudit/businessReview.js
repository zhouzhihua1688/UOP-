...
module.exports = function (app) {
    ...
    app.post('/customerService/bankCardAudit/businessReview/getList.ajax', (req, res, next) => {
        ...
        console.log('/customerService/bankCardAudit/businessReview/getList.ajax option:', {
            ...option,
            req: '#'
        });
        request(option, (error, response, body) => {
            ...
            console.log('/customerService/bankCardAudit/businessReview/getList.ajax body:', '****');
            if (error) {
                return res.send({
                    error: 1,
                    msg: '数据获取失败'
    ...
    // 导出
    app.get('/customerService/bankCardAudit/businessReview/exportExcel.ajax', (req, res, next) => {
        ...
        console.log('/customerService/bankCardAudit/businessReview/exportExcel.ajax option:', {
            ...option,
            req: '#'
        });
        // request(option).pipe(res);
        request(option, (error, response, body) => {
            console.log('/customerService/bankCardAudit/businessReview/exportExcel.ajax error:', error);
            console.log('/customerService/bankCardAudit/businessReview/exportExcel.ajax statusCode:', response && response.statusCode);
            console.log('/customerService/bankCardAudit/businessReview/exportExcel.ajax body:', body);
            if (error) {
                return res.send({
                    error: 1,
                    msg: '操作失败'
