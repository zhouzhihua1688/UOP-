...
module.exports = {
		filePathExternal: uopStaticFilePath ? (uopStaticFilePath + '/advertising') : (devFilePath + '/advertising'),
		filePafilePathExternalthUrl: uopStaticFilePath ? (uopStaticFilePath_url + '/advertising') : (devFilePath + '/advertising'),
    userMgmt:{
        userList:{
