...
module.exports = function (app) {
    app.get('/advertising/:menu/:page', (req, res, next) => {
        let channel = 'advertising';
    ...
    app.get('/advertising/:menu', (req, res, next) => {
    ...
    require('./productMaterialMgmt')(app);
    require('./materialMgmt')(app);
