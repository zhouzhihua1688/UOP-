...
module.exports = function (app) {
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/getServiceData.ajax', (req, res, next) => {
        ...
        if (paramsStatus.type == "0") {
            new Promise(function (resolve, reject) {
                ...
                let option = {
                    pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/getServiceData.ajax',
                    req,
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/getTableData.ajax', (req, res, next) => {
        ...
        if (paramsStatus.type == "1") {
            ...
            new Promise(function (resolve, reject) {
                ...
                console.log('/businessMgmt/businessParamConfigOC/quotaReview/getTableData.ajax sql:', sql);
                pool.getConnection((error, connection) => {
                    ...
                    connection.query(sql, function (error, results, fields) {
                        ...
                        console.log('/businessMgmt/businessParamConfigOC/quotaReview/getTableData.ajax results:', results);
                        console.log('/businessMgmt/businessParamConfigOC/quotaReview/getTableData.ajax fields:', fields);
                        if (error) {
                            reject({
                                error: 1,
                                msg: '经办数据查询失败'
                ...
                return new Promise((resolve, reject) => {
                    ...
                    params.pmkey = "TAPKIND"
                    let option = {
                        pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/getTableData.ajax',
                        req,
                        url: apiUrlList.params,
                        qs: params,
                        timeout: 15000,
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/apkinds.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/apkinds.ajax',
            req,
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/reviewPass.ajax', (req, res, next) => {
        ...
        let operateService = function (item) {
            ...
            return new Promise((resolve, reject) => {
                if (operate == 2) {
                    let option = {
                        pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/reviewPass.ajax',
                        req,
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/SavePass.ajax', (req, res, next) => {
        ...
        let operateService = function (item) {
            ...
            return new Promise((resolve, reject) => {
                if (operate == 1) {
                    let option = {
                        pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/SavePass.ajax',
                        req,
                        operateType: operate, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/tradeTypeList.ajax', (req, res, next) => {
        ...
        req.body.pmkey && (params.pmkey = req.body.pmkey);
        let option = {
            pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/tradeTypeList.ajax',
            req,
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/channelTypeList.ajax', (req, res, next) => {
        ...
        req.body.pmkey && (params.pmkey = req.body.pmkey);
        let option = {
            pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/channelTypeList.ajax',
            req,
    ...
    app.post('/businessMgmt/businessParamConfigOC/quotaReview/fundList.ajax', (req, res, next) => {
        ...
        let fundList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/fundList.ajax --fundList',
                req,
        ...
        let groupList = new Promise(resolve => {
            let option = {
                pageUrl: '/businessMgmt/businessParamConfigOC/quotaReview/fundList.ajax --groupList',
                req,
                url: apiUrlList.params,
                qs: {
                    pmst: 'SYSTEM',
