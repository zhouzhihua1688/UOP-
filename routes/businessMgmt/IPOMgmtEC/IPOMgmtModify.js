...
module.exports = function (app) {
    // 获取  select选择项数据
    app.post('/businessMgmt/IPOMgmtEC/IPOMgmt/modifySelectOption.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/businessMgmt/IPOMgmtEC/IPOMgmt/modifySelectOption.ajax',
            req,
    ...
    // 获取  修改数据
    app.post('/businessMgmt/IPOMgmtEC/IPOMgmt/modifyLineData.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/businessMgmt/IPOMgmtEC/IPOMgmt/modifyLineData.ajax',
            req,
    ...
    // 获取本地修改数据
    app.post('/businessMgmt/IPOMgmtEC/IPOMgmt/modifyLocalData.ajax', (req, res, next) => {
        let params = req.body;
        console.log('params', params)

        var $sql = `SELECT  content,update_timestamp FROM ${tableName} WHERE delete_flag='F'&&service_id='${params.service_id}'&&local_id=${params.local_id};`
    ...
    // 修改
    app.post('/businessMgmt/IPOMgmtEC/IPOMgmt/modifyModify.ajax', (req, res, next) => {
        let params = req.body;
        ...
        let updating = formatTimeStamp(new Date());
        console.log(params)
        ...
        sql_query(res, $sql, [], function (err, data) { //判断是否存在
            if (err) {
                console.log('/businessMgmt/IPOMgmtEC/IPOMgmt/modifyModify.ajax', err)
                return res.send({
                    error: 1,
                    msg: '修改失败'
                });
