...
const apiUrlList = require('../apiConfig').pauseTradeMgmt.pauseTradeHandle;
const tableName = 'bm_ptm_pause';

module.exports = function (app) {
    //查询列表数据
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax', (req, res, next) => {
        let paramsStatus = {};
        let params = {};
        ...
        if (paramsStatus.type == "1") {
            ...
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax sql:', sql);
            pool.getConnection((err, connection) => {
                ...
                connection.query(sql, function (error, results, fields) {
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax error:', error);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax results:', results);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax fields:', fields);
                    if (error) {
                        return res.send({
                            error: 1,
                            msg: '操作失败'
        ...
        if (paramsStatus.type == "0") {
            ...
            // 查询后端业务数据
            let option = {
                pageUrl: '/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax',
                req,
            ...
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax option:', option);
            request.get(option, (error, response, body) => {
                console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax error:', error);
                console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax statusCode:', response && response.statusCode);
                console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/getTableData.ajax body:', body);
                if (error) {
                    return res.send({
                        error: 1,
                        msg: '查询失败'
    ...
    //添加保存数据;
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/saveParam.ajax', (req, res, next) => {
        // 由我经办增加保存
        pool.getConnection(function (error, connection) {
            ...
            let typeIds = JSON.parse(content).accptmd;
            ...
            if (paramsStatus.type == "1") {
                ...
                console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/saveParam.ajax sql:', sql);
                ...
                connection.query(sql, function (error, results, fields) {
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/saveParam.ajax error:', error);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/saveParam.ajax results:', results);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/saveParam.ajax fields:', fields);
                    if (error) {
                        return res.send({
                            error: 1,
                            msg: '保存失败'
    ...
    //修改业务数据存到经办数据库中;
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/serviceSave.ajax', (req, res, next) => {
        //修改本地Mysql参数
        let paramsStatus = {};
        paramsStatus.type = req.body.type; //传过来的状态数值
        ...
        if (paramsStatus.type == "0") {
            ...
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/serviceSave.ajax sql:', sql);
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/serviceSave.ajax params:', params);
            pool.getConnection((err, connection) => {
                if (err) {
                    return res.send({
                        error: 1,
                ...
                connection.query(sql, {
                    ...
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/serviceSave.ajax error:', error);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/serviceSave.ajax results:', results);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/serviceSave.ajax fields:', fields);
                    if (error) {
                        return res.send({
                            error: 1,
                            msg: '保存失败'
    ...
    //修改本地数据;
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/localRevise.ajax', (req, res, next) => {
        //修改本地Mysql参数
        let paramsStatus = {};
        paramsStatus.type = req.body.type; //传过来的状态数值
        let operate = req.body.operate //操作类型
        if (paramsStatus.type == "1") {
            ...
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/localRevise.ajax sql:', sql);
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/localRevise.ajax params:', params);
            pool.getConnection((err, connection) => {
                if (err) {
                    return res.send({
                        error: 1,
                ...
                connection.query(sql, [params, updateTime, mysqlId], function (error, results, fields) {
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/localRevise.ajax error:', error);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/localRevise.ajax results:', results);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/localRevise.ajax fields:', fields);
                    if (error) {
                        return res.send({
                            error: 1,
                            msg: '修改失败'
    ...
    //删除业务数据存到本地数据库中;
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteParam.ajax', (req, res, next) => {
        // 删除本地数据-软删除
        let paramsStatus = {};
        paramsStatus.type = req.body.type; //传过来的状态数值
        ...
        if (paramsStatus.type == "0") {
            ...
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteParam.ajax sql:', sql);
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteParam.ajax params:', params);
            pool.getConnection((err, connection) => {
                if (err) {
                    return res.send({
                        error: 1,
                ...
                connection.query(sql, {
                    ...
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteParam.ajax error:', error);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteParam.ajax results:', results);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteParam.ajax fields:', fields);
                    if (error) {
                        return res.send({
                            error: 1,
                            msg: '保存失败'
    ...
    //撤销本地数据
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteLocal.ajax', (req, res, next) => {
        // 撤销本地数据-软删除
        let paramsStatus = {};
        paramsStatus.type = req.body.type; //传过来的状态数值
        var operate = req.body.operate
        if (paramsStatus.type == "1") {
            ...
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteLocal.ajax sql:', sql);
            console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteLocal.ajax params:', params);
            pool.getConnection((err, connection) => {
                if (err) {
                    return res.send({
                        error: 1,
                ...
                connection.query(sql, [mysqlId], function (error, results, fields) {
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteLocal.ajax error:', error);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteLocal.ajax results:', results);
                    console.log('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/deleteLocal.ajax fields:', fields);
                    if (error) {
                        return res.send({
                            error: 1,
                            msg: '撤销失败'
    ...
    // 获取用户信息
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/userName.ajax', (req, res, next) => {
        let operator = req.session.loginInfo.userid
        return res.send({
            error: 0,
            msg: '成功',
    ...
    app.post('/businessMgmt/pauseTradeMgmt/pauseTradeHandle/collection.ajax', (req, res, next) => {
        ...
        let params = req.body;
        let option = {
            pageUrl: '/businessMgmt/pauseTradeMgmt/pauseTradeHandle/collection.ajax',
            req,
