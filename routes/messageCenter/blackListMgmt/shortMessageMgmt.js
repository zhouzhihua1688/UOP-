...
module.exports = function (app) {
    ...
    app.post('/messageCenter/blackListMgmt/shortMessageMgmt/getTableData.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/messageCenter/blackListMgmt/shortMessageMgmt/getTableData.ajax',
            req: req,
    ...
    app.post('/messageCenter/blackListMgmt/shortMessageMgmt/saveParam.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/messageCenter/blackListMgmt/shortMessageMgmt/saveParam.ajax',
            req: req,
    ...
    app.post('/messageCenter/blackListMgmt/shortMessageMgmt/deleteParam.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/messageCenter/blackListMgmt/shortMessageMgmt/deleteParam.ajax',
            req: req,
