...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendViewMgmt/channelMgmt/queryInfo.ajax', (req, res, next) => {
            ...
            let option = {
                pageUrl: '/recommendSystem/recommendViewMgmt/channelMgmt/queryInfo.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendViewMgmt/channelMgmt/delete.ajax', (req, res, next) => {
            let params = req.body;
            let option = {
                pageUrl: '/recommendSystem/recommendViewMgmt/channelMgmt/delete.ajax',
                req: req,
    ...
    app.post('/recommendSystem/recommendViewMgmt/channelMgmt/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendViewMgmt/channelMgmt/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendViewMgmt/channelMgmt/update.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendViewMgmt/channelMgmt/update.ajax',
            req: req,
        ...
        //渠道列表
    app.post('/recommendSystem/recommendViewMgmt/channelMgmt/channelMenu.ajax', (req, res, next) => {
            let option = {
                pageUrl: '/recommendSystem/recommendViewMgmt/channelMgmt/channelMenu.ajax',
                req: req,
