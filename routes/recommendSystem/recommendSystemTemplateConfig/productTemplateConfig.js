...
module.exports = function (app) {
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/queryInfo.ajax', (req, res, next) => {
			if (req.body.channelId) {
				...
				let option = {
					pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/queryInfo.ajax',
					req: req,
				...
				let getChannelList = new Promise((resolve, reject) => {
					let option = {
						pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/queryInfo.ajax ---getOneChannel',
						req: req,
				...
				getChannelList.then((result) => {
					...
					if (firstChannel) {
						...
						params.pageNo = parseInt(params.pageNo);
						params.pageSize = parseInt(params.pageSize);
						!params.prdConfigId&&(params.channelId = firstChannel);
						let userId = req.session.loginInfo.userid;
						let option = {
							pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/queryInfo.ajax',
							req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/delete.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/delete.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/add.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/add.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/update.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/update.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/adviceDisplayStyle.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/adviceDisplayStyle.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/adviceTpListQuery.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/adviceTpListQuery.ajax',
            req: req,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/fresh.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/fresh.ajax',
            req: req,
            operateType: 2, // operateType:操作类型 0:登录 1:新增 2:修改 3:删除 4:修改密码
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/viewList.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/viewList.ajax',
            req: req,
    ...
    // 获取imgUrlList
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/imageUrlList.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/imageUrlList.ajax',
            req: req,
            url: apiUrlList.imageUrlList,
            qs: req.body,
            timeout: 15000,
            json: true
        };
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/channelMenu.ajax', (req, res, next) => {
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/channelMenu.ajax',
            req: req,
            url: apiUrlList.channelMenu,
            qs: req.body,
            timeout: 15000,
    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/queryFundIdList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/recommendSystem/recommendSystemTemplateConfig/productTemplateConfig/queryFundIdList.ajax',
            req: req,
