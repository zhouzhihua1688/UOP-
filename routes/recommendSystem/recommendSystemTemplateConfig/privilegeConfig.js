    ...
    app.post('/recommendSystem/recommendSystemTemplateConfig/privilegeConfig/queryInfo.ajax', (req, res, next) => {
			if (req.body.channelId) {
				...
				let getChannelList = new Promise((resolve, reject) => {
					let option = {
						pageUrl: '/recommendSystem/recommendSystemTemplateConfig/privilegeConfig/queryInfo.ajax ---getOneChannel',
						req: req,
				...
				getChannelList.then((result) => {
					...
					if (firstChannel) {
						...
						params.pageNo = parseInt(params.pageNo);
						params.pageSize = parseInt(params.pageSize);
						!params.privilegeConfigId&&(params.channelId = firstChannel);
						let userId = req.session.loginInfo.userid;
						let option = {
							pageUrl: '/recommendSystem/recommendSystemTemplateConfig/privilegeConfig/queryInfo.ajax',
							req: req,
