...
module.exports = function (app) {
    app.get('/investmentMgmt/:menu/:page', (req, res, next) => {
        let pageType = req.query.pageType ? req.query.pageType : '';
        let channel = 'investmentMgmt';
    ...
    app.get('/investmentMgmt/:menu', (req, res, next) => {
        let channel = 'investmentMgmt';
        let menu = req.params.menu;
        let renderData = {
            channel: channel,
    ...
    // 二级菜单路由
    require('./investmentStrategy')(app);
    require('./investmentStrategyMonitoring')(app);
    require('./investmentInformationDisclosure')(app);
    require('./investmentAccount')(app);
    require('./recordMgmt')(app);
    require('./tradeMonitor')(app);
    require('./investmentRiskMonitor')(app);
};
