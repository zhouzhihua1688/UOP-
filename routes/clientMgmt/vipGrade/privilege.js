...
module.exports = function (app) {
    ...
    app.post('/clientMgmt/vipGrade/privilege/getList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/clientMgmt/vipGrade/privilege/getList.ajax',
            req: req,
            url: apiUrl.dataList,
            qs: params,
            timeout: 15000,
    ...
    app.post('/clientMgmt/vipGrade/privilege/dataChange.ajax', (req, res, next) => {
        ...
        form.parse(req, (err, fields, files) => {
            ...
            if (err) {
                ...
                let option = {
                    pageUrl: '/clientMgmt/vipGrade/privilege/dataChange.ajax',
                    req: req,
    ...
    app.post('/clientMgmt/vipGrade/privilege/dataDelete.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/clientMgmt/vipGrade/privilege/dataDelete.ajax',
            req: req,
    ...
    app.post('/clientMgmt/vipGrade/privilege/dataAdd.ajax', (req, res, next) => {
        ...
        form.parse(req, (err, fields, files) => {
            ...
            if (err) {
                ...
                let option = {
                    pageUrl: '/clientMgmt/vipGrade/privilege/dataAdd.ajax',
                    req: req,
