...
module.exports = function (app) {
    ...
    app.post('/clientMgmt/vipGrade/source/getList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/clientMgmt/vipGrade/source/getList.ajax',
            req: req,
            url: apiUrl.dataList,
            qs: params,
            timeout: 15000,
    ...
    app.post('/clientMgmt/vipGrade/source/dataAdd.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/clientMgmt/vipGrade/source/dataAdd.ajax',
            req: req,
    ...
    app.post('/clientMgmt/vipGrade/source/dataChange.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/clientMgmt/vipGrade/source/dataChange.ajax',
            req: req,
    ...
    app.post('/clientMgmt/vipGrade/source/dataDelete.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/clientMgmt/vipGrade/source/dataDelete.ajax',
            req: req,
