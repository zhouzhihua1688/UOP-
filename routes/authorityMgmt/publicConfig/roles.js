...
module.exports = function (app) {
    //获取角色数据
    app.post('/authorityMgmt/publicConfig/roles/roleData.ajax', (req, res, next) => {
        let option = {
            session: req.session,
        ...
        console.log('/authorityMgmt/publicConfig/roles/roleData.ajax option1:', option);
        request(option, (error, response, body) => {
            console.log('/authorityMgmt/publicConfig/roles/roleData.ajax error:', error);
            console.log('/authorityMgmt/publicConfig/roles/roleData.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/publicConfig/roles/roleData.ajax roleData:', body);
            if (error) {
    ...
    //查看角色url
    app.post('/authorityMgmt/publicConfig/roles/checkTree.ajax', (req, res, next) => {
        let option = {
            session: req.session,
        ...
        console.log('/authorityMgmt/publicConfig/roles/getMenuData.ajax option:', option);
        request(option, (error, response, body) => {
            console.log('/authorityMgmt/publicConfig/roles/getMenuData.ajax error:', error);
            console.log('/authorityMgmt/publicConfig/roles/getMenuData.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/publicConfig/roles/getMenuData.ajax body:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
    ...
    //删除角色
    app.post('/authorityMgmt/publicConfig/roles/deleteRole.ajax', (req, res, next) => {
        let option = {
            session: req.session,
            url: apiUrlList.roleUrl,
            timeout: 15000,
        ...
        console.log('/authorityMgmt/publicConfig/roles/deleteRole.ajax option:', option);
        request.del(option, (error, response, body) => {
            console.log('/authorityMgmt/publicConfig/roles/deleteRole.ajax error:', error);
            console.log('/authorityMgmt/publicConfig/roles/deleteRole.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/publicConfig/roles/deleteRole.ajax body:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
    ...
    //保存新建
    app.post('/authorityMgmt/publicConfig/roles/saveRole.ajax', (req, res, next) => {
        let params = {};
        ...
        console.log('/authorityMgmt/publicConfig/roles/saveRole.ajax option:', option);
        request(option, (error, response, body) => {
            console.log('/authorityMgmt/publicConfig/roles/saveRole.ajax error:', error);
            console.log('/authorityMgmt/publicConfig/roles/saveRole.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/publicConfig/roles/saveRole.ajax body:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
