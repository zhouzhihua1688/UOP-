...
module.exports = function (app) {
    //获取用户数据
    app.post('/authorityMgmt/thirdPartyOperation/users/getUserInfo.ajax', (req, res, next) => {
        let option = {
            session: req.session,
        ...
        console.log('/authorityMgmt/thirdPartyOperation/users/getUserInfo.ajax option:', option);
        request(option, (error, response, body) => {
            console.log('/authorityMgmt/thirdPartyOperation/users/getUserInfo.ajax error:', error);
            console.log('/authorityMgmt/thirdPartyOperation/users/getUserInfo.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/thirdPartyOperation/users/getUserInfo.ajax body:', body);
            if (error) {
    ...
    //获取角色数据
    app.post('/authorityMgmt/thirdPartyOperation/users/getRoleInfo.ajax', (req, res, next) => {
        let option = {
            session: req.session,
        ...
        console.log('/authorityMgmt/thirdPartyOperation/users/getRoleInfo.ajax option:', option);
        request(option, (error, response, body) => {
            console.log('/authorityMgmt/thirdPartyOperation/users/getRoleInfo.ajax error:', error);
            console.log('/authorityMgmt/thirdPartyOperation/users/getRoleInfo.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/thirdPartyOperation/users/getRoleInfo.ajax body:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
    ...
    //删除用户的角色
    app.post('/authorityMgmt/thirdPartyOperation/users/deleteUserRole.ajax', (req, res, next) => {
        let params = {};
        ...
        console.log('/authorityMgmt/thirdPartyOperation/users/deleteUserRole.ajax option:', option);
        request.del(option, (error, response, body) => {
            console.log('/authorityMgmt/thirdPartyOperation/users/deleteUserRole.ajax error:', error);
            console.log('/authorityMgmt/thirdPartyOperation/users/deleteUserRole.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/thirdPartyOperation/users/deleteUserRole.ajax body:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
    ...
    //查看角色url
    app.post('/authorityMgmt/thirdPartyOperation/users/checkTree.ajax', (req, res, next) => {
        let option = {
            session: req.session,
        ...
        console.log('/authorityMgmt/thirdPartyOperation/users/getMenuData.ajax option:', option);
        request(option, (error, response, body) => {
            console.log('/authorityMgmt/thirdPartyOperation/users/getMenuData.ajax error:', error);
            console.log('/authorityMgmt/thirdPartyOperation/users/getMenuData.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/thirdPartyOperation/users/getMenuData.ajax body:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
    ...
    //分配角色权限
    app.post('/authorityMgmt/thirdPartyOperation/users/distributeRole.ajax', (req, res, next) => {
        let params = {
        ...
        console.log('/authorityMgmt/thirdPartyOperation/users/distributeRole.ajax option:', option);
        request.post(option, (error, response, body) => {
            console.log('/authorityMgmt/thirdPartyOperation/users/distributeRole.ajax error:', error);
            console.log('/authorityMgmt/thirdPartyOperation/users/distributeRole.ajax statusCode:', response && response.statusCode);
            console.log('/authorityMgmt/thirdPartyOperation/users/distributeRole.ajax result:', body);
            if (error) {
                console.log('error:', error);
                return res.send({error: 1, msg: '操作失败'});
            }
