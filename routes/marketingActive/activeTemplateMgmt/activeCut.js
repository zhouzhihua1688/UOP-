...
module.exports = function (app) {
    ...
    app.post('/marketingActive/activeTemplateMgmt/activeCut/getList.ajax', (req, res, next) => {
        ...
        let option = {
            pageUrl: '/marketingActive/activeTemplateMgmt/activeCut/getList.ajax',
            req,
            url: apiUrl.dataList,
            qs: params,
            timeout: 15000,
    ...
    app.post('/marketingActive/activeTemplateMgmt/activeCut/dataAdd.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeTemplateMgmt/activeCut/dataAdd.ajax',
            req,
            url: apiUrl.dataAdd,
            body: params,
            timeout: 15000,
    ...
    app.post('/marketingActive/activeTemplateMgmt/activeCut/dataChange.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeTemplateMgmt/activeCut/dataChange.ajax',
            req,
    ...
    app.post('/marketingActive/activeTemplateMgmt/activeCut/dataDelete.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeTemplateMgmt/activeCut/dataDelete.ajax',
            req,
    ...
    app.post('/marketingActive/activeTemplateMgmt/activeCut/dataQuery.ajax', (req, res, next) => {
        let params = req.body;
        let option = {
            pageUrl: '/marketingActive/activeTemplateMgmt/activeCut/dataQuery.ajax',
            req,
