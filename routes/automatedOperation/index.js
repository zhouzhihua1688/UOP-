...
module.exports = function (app) {
    app.get('/automatedOperation/:menu/:page', (req, res, next) => {
        let channel = 'automatedOperation';
    ...
    app.get('/automatedOperation/:menu', (req, res, next) => {
    ...
    require('./modelMgmt')(app);
    require('./triggerNodeMgmt')(app);
    require('./reachContentMgmt')(app);
    require('./taskTrackerQuery')(app);
    require('./systemConfig')(app);
    require('./operatePlanMgmt')(app);
};
