new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            var params = {};
            var _this = this;
            this.channelNo && (params.channelNo = this.channelNo);
            this.channelNm && (params.channelNm = this.channelNm);
            params.pageNo = currentIndex + 1;
            params.pageSize = this.pageMaxNum;
            $.post({
                url: '/awardMgmt/awardSetting/portSetting/getTableData.ajax',
                data: params,
        ...
        setAddData: function (obj) {
            ...
            this.diaChannelNm = obj.channelNm ? obj.channelNm : '';
        ...
        deleteData: function () {
            var _this = this;
            $.post({
                url: '/awardMgmt/awardSetting/portSetting/delete.ajax',
        ...
        diaInfoCheck: function () {
            if (!this.diaChannelNo) {
                this.showDialog('add', 'info', true, '渠道编号不能为空');
                return false;
            }
            if (!this.diaChannelNm) {
                this.showDialog('add', 'info', true, '渠道名称不能为空');
                return false;
            }
            return true;
        },
        add: function () {
            ...
            if (this.diaInfoCheck()) {
                ...
                params.channelNm = this.diaChannelNm;
                params.remark = this.diaRemark;
                this.isUpdate && (params.id = this.updateId);
                var url = '/awardMgmt/awardSetting/portSetting/';
