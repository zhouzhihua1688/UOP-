new Vue({
    ...
    methods: {
        ...
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/automatedOperation/taskTrackerQuery/taskTrackerRecordQuery/searchList.ajax',
                data: params,
        ...
        getBlockTableData: function (currentIndex, modelId) {
            ...
            $.post({
                url: '/automatedOperation/taskTrackerQuery/taskTrackerRecordQuery/searchBlockList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        if (result.data.rows && result.data.rows.length > 0) {
