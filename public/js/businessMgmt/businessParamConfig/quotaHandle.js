new Vue({
    ...
    methods: {
        ...
        fundList:function(){
            var _this = this;
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/fundList.ajax',
        ...
        subApkinds: function (item) {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/subApkinds.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        userName: function () {
            ...
            var operator;
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/userName.ajax',
                success: function (result) {
                    if (result.error === 0) {
        ...
        //     var _this = this, arr;
        //     $.post({
        //         url: '/businessMgmt/businessParamConfig/quotaHandle/getTableData.ajax',
        //         data: {
        //             type: 1,
        //             product: '',
        //             reviewStatus: "",
        ...
        custTypeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/custTypeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        tradeTypeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/tradeTypeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        channelTypeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/channelTypeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        quotaTypeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/quotaTypeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        branchCodeList: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/branchCodeList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        showAdd: function () {
            ...
            // 获取规则编号
            // $.post({
            //     url: '/businessMgmt/businessParamConfig/quotaHandle/ruleId.ajax',
            //     success: function (result) {
            //         if (result.error === 0) {
        ...
        saveParam: function () {
            ...
            if (this.diaInfoCheck()) {
                ...
                if(this.accoType==""){
                    ...
                    params.accoType = this.accoType;
                }
                console.log(params)
                $.post({
                    url: '/businessMgmt/businessParamConfig/quotaHandle/saveParam.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
        ...
        serviceSave: function () {
            ...
            if (this.reviseCheck()) {
                ...
                console.log(params)
                $.post({
                    url: '/businessMgmt/businessParamConfig/quotaHandle/serviceSave.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
                            // _this.getlocalList()
        ...
        localUpdate: function (item) {
            ...
            //     success: function (result) {
            //         if (result.error === 0) {
            //             var apkindAllList=result.data.body;
            //             for (let ApkItem of apkindAllList) {
            //                 if (_this.apkind === ApkItem.pmco) {
            //                     _this.apkind=ApkItem.pmco
            //                     break;
            //                 }
            //             }
            //         }
        ...
        localRevise: function () {
            ...
            if (this.reviseCheck()) {
                ...
                console.log(params)
                $.post({
                    url: '/businessMgmt/businessParamConfig/quotaHandle/localRevise.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
                            // _this.getlocalList()
        ...
        deleteUser: function () {
            ...
            console.log(params)
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/deleteParam.ajax',
                // data: {ids: ids.join(',')},
                data: params,
                traditional: true,
                success: function (result) {
        ...
        deleteUser2: function () {
            ...
            params.operate = this.operate
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/deleteLocal.ajax',
                data: params,
                traditional: true,
                success: function (result) {
                    if (result.error === 0) {
        ...
        deleteAgain:function () {
            ...
            // params.accoType = "*" //默认
            $.post({
                url: '/businessMgmt/businessParamConfig/quotaHandle/deleteAgain.ajax',
                data: params,
                traditional: true,
                success: function (result) {
                    if (result.error === 0) {
    ...
    filters: {
        ...
        custType: function (item) {
            if (item == "0") {
                ...
                return "产品"
            }else if (item.indexOf("0")!= -1&&item.indexOf("1")!= -1) {
                return "企业,个人"
            }else if (item.indexOf("0")!= -1&&item.indexOf("2")!= -1) {
                return "企业,产品"
            }else if (item.indexOf("1")!= -1&&item.indexOf("2")!= -1) {
                return "个人,产品"
            }else {
                return "*"
            }
