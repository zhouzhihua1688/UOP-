var vm = new Vue({
    ...
    methods: {
        ...
        serviceCheckDialog: function (item) {
            ...
            this.service.dialog_accoType= item.accoType;
        ...
        serviceToLocalUpdate: function () {
            ...
            var content = {
                ...
                accoType: this.service.dialog_accoType,
        ...
        searchLocal: function () {
            ...
            var accoType = this.local.accoType;   //账号类型
            var _this = this;
            var params = {
                product: product,
                tradeType: tradeType,
        ...
        localCheckDialog: function (item) {
            ...
            this.local.dialog_accoType = item.accoType;
        ...
        showAddLocal: function () {
            ...
            this.local.dialog_accoType = '';      //账号类型
        ...
        addLocal: function () {
            ...
            this.local.dialog_product=this.fundList.join()
            if(this.local.dialog_accoType==""){
                this.local.dialog_accoType="*"
            }
            var content = {
                product: this.local.dialog_product,
                accoType: this.local.dialog_accoType,
                custType: custType,
        ...
        showSubmitAgain: function (item) {
            ...
            this.local.submitAgain_accoType = item.accoType;
        ...
        submitAgain: function () {
            ...
            var content = {
                ...
                accoType: this.local.submitAgain_accoType,
