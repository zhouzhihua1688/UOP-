new Vue({
    ...
    methods: {
        getDialogList: function () {
            var _this = this;
            $.post({
                url: '/businessMgmt/businessParamConfig/discountReview/getDialogList.ajax',
        ...
        searchService: function () {
            ...
            params.accoType = this.service.accoType;
            $.post({
                url: '/businessMgmt/businessParamConfig/discountReview/getServiceList.ajax',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
        ...
        search: function () {
            ...
            var accoType = this.accoType;
            var tradeType = this.tradeType;
            var oproduct = this.oproduct;
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/discountReview/getLocalList.ajax',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
        ...
        checkDialog: function (item) {
            ...
            this.dialog_accoType = item.accoType;
            ...
            if(item.originData){
                ...
                this.origin_accoType = item.originData.accoType;
        ...
        reviewReject: function () {
            ...
            $.post({
                url: '/businessMgmt/businessParamConfig/discountReview/reviewReject.ajax',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
        ...
        reviewAccept: function () {
            ...
            var params = JSON.parse(this.itemData);
            $.post({
                url: '/businessMgmt/businessParamConfig/discountReview/reviewAccept.ajax',
                data: params,
                success: function (result) {
                    if (result.error == 0) {
