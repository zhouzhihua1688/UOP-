...
new Vue({
    ...
    created: function () {
        $.post({//基金名称查询
            url: '/businessMgmt/IPOMgmtEC/IPOMgmtReview/collection.ajax',
            data: {
        ...
        var _this = this;
        $.post({//注册登记代码
            url: '/businessMgmt/IPOMgmtEC/IPOMgmtReview/selectOption.ajax',
            data: {
                pmst: 'SYSTEM',
                pmkey: 'TANO'
            },
    ...
    methods: {
        getTableData: function (currentIndex, load) {
            ...
            if (this.dataFlag == 'line') {
                ...
                url = '/businessMgmt/IPOMgmtEC/IPOMgmtReview/getLineList.ajax';
            } else {
                url = '/businessMgmt/IPOMgmtEC/IPOMgmtReview/getLocalList.ajax';
        ...
        rejectFund: function (item) {
            ...
            if (this.alwaysClick) {
                ...
                $.post({
                    url: '/businessMgmt/IPOMgmtEC/IPOMgmtReview/rejectFund.ajax',
                    data: params,
                    success: function (result) {
        ...
        passFund: function (item) {
            ...
            if (this.alwaysClick) {
                this.alwaysClick = false;
                $.post({
                    url: '/businessMgmt/IPOMgmtEC/IPOMgmtReview/passFund.ajax',
                    data: params,
                    success: function (result) {
                        _this.alwaysClick = true;
                        _this.getTableData(_this.currentIndex)
        ...
        windowsGoTo: function (item) {
            ...
            window.location.href = '/businessMgmt/IPOMgmtEC/IPOMgmtReview.html?pageType=Detail&service_id=' + fundid + '&local_id=' + item.local_id
        }
    },
    filters: {
