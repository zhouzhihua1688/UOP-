...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            this.currentIndex= 0;
            $.post({
                url: '/businessMgmt/combinationProductConfig/productPoolMgmt/getTableData.ajax',
                // data: params,
        ...
        showRefresh:function () {
            var _this=this
            $.post({
                url: '/businessMgmt/combinationProductConfig/productPoolMgmt/showRefresh.ajax',
                // data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        exportAlls:function(){
            var _this = this;
            var url;
            url = '/businessMgmt/combinationProductConfig/productPoolMgmt/exportAlls.ajax'
