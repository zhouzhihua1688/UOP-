new Vue({
    ...
    mounted: function () {
        var dialogs = ['info', 'del', 'add', "update", "revise", 'reviewReject', "checkDatils",'checkFund'];
        var _this = this;
    ...
    methods: {
        ...
        branchCodeLists: function () {
            var _this = this
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/branchCodeList.ajax',
                data: {
                    pmst: "SYSTEM",
                    pmkey: "BRANCHCODE"
                },
        ...
        GroupList: function (item) {
            var _this = this
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/fundGroups.ajax',
                success: function (result) {
                    if (result.error === 0) {
        ...
        groupFundType: function () {
            var _this = this;
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/fundGroupType.ajax',
                data: {
                    pmst: "SYSTEM",
        ...
        groupTypeList: function () {
            var _this = this
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/grouptypeList.ajax',
                data: {
                    pmst: "SYSTEM",
                    pmkey: "GROUPRISKTYPE"
                },
        ...
        riskLevelList: function () {
            var _this = this
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/risklevelList.ajax',
                data: {
                    pmst: "SYSTEM",
        ...
        agerangeList: function () {
            var _this = this;
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/ageRangeList.ajax',
                data: {
                    pmst: "SYSTEM",
        ...
        getTableData: function (currentIndex, type) {
            ...
            if (type == 0) {
                ...
                $.post({
                    url: '/businessMgmt/combinationProductConfig/combinationProductReview/getTableData.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
                            this.pageMaxNum = 1;
        ...
        reviewPass: function (item) {
            ...
            if(item.dialogData){ // dialogData存在，为全量修改
                $.post({
                    url: '/businessMgmt/combinationProductConfig/combinationProductReview/allUpdateReviewPass.ajax',   //修改基本信息
            ...
            if (this.type == 1) {
                if (params.operate != 1 && params.operate != 3) {
                    if (!fundgroupChangeROList && fundgroupNewFundgroupDO && fundgroupSubdatetimeRO) {
                        console.log("修改基本信息")
                        $.post({
                            url: '/businessMgmt/combinationProductConfig/combinationProductReview/reviewPass.ajax',   //修改基本信息
                            data: params,
                            success: function (result) {
                                if (result.error === 0) {
                        ...
                        $.post({
                            url: '/businessMgmt/combinationProductConfig/combinationProductReview/reviewPass1.ajax',   //只是修改调仓说明和是否显示
                            data: params,
                            success: function (result) {
                                if (result.error === 0) {
                                    _this.getTableData(0, params.type);
                        ...
                        $.post({
                            url: '/businessMgmt/combinationProductConfig/combinationProductReview/checkFund.ajax',  //验证是否处于分红中
                            data:{
                            ...
                            success: function (result) {
                                if (result.error === 0) {
                                    if(result.data.body==true){
                                        $.post({
                                            url: '/businessMgmt/combinationProductConfig/combinationProductReview/reviewPass2.ajax',   //修改里新增调仓
                                            data: params,
                                            success: function (result) {
                                                if (result.error === 0) {
                                                    _this.getTableData(0, params.type);
                                    ...
                                    $("#checkBtn").click(function () {
                                        $.post({
                                            url: '/businessMgmt/combinationProductConfig/combinationProductReview/reviewPass2.ajax',
                                            data: params,
                                            success: function (result) {
                                                if (result.error === 0) {
                                                    _this.getTableData(0, params.type);
                    ...
                    $.post({
                        url: '/businessMgmt/combinationProductConfig/combinationProductReview/reviewPass.ajax',
                        data: params,
                        success: function (result) {
                            if (result.error === 0) {
                                _this.getTableData(0, params.type);
                    ...
                    $.post({
                        ...
                        success: function (result) {
                            if (result.error === 0) {
                                if(result.data.body==true){
                                    $.post({
                                        url: '/businessMgmt/combinationProductConfig/combinationProductReview/SavePass.ajax',
                                        data: params,
                                        success: function (result) {
                                            if (result.error === 0) {
                                                _this.getTableData(0, params.type);
        ...
        calc:function(item){
            ...
            console.log(params)
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/calcParams.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0, params.type);
        ...
        reviewReject: function (item) {
            ...
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/reviewReject.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0, params.type);
        ...
        showLocalAllUpdate: function(localItem){
            $.post({
                url: '/businessMgmt/combinationProductConfig/combinationProductReview/getLocalDialogListData.ajax',
                success: function (result) {
                    if (result.error === 0) {
