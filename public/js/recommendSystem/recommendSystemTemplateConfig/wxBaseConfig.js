new Vue({
    ...
    mounted: function () {
        ...
        //查询推荐类型接口
        $.post({
            url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/queryRecommendTp.ajax',
    ...
    methods: {
        ...
        getOneDetail: function (objconfigId) {
            ...
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/queryInfo.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        getViewData: function (val,once) {
            ...
            params.contentTp = 'wx_funcbtn';
            val && (params.temId = val);
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/viewList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        if (result.data.rows.length > 0) {
        ...
        add: function () {
            ...
            var _this = this;
                ...
                var url = '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/';
        ...
        uploadPic1: function () {
            ...
            var _this = this;
            $.ajaxFileUpload({
                url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/upload1.ajax',
                type: 'POST',
                dataType: 'json',
        ...
        enableOrDisable: function (item) {
            var _this = this;
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/enable.ajax',
        ...
        deleteConfirm: function () {
            var _this = this;
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/delete.ajax',
                data: {btnId: this.deleteId},
                success: function (result) {
                    if (result.error === 0) {
                        _this.showDialog('', 'info', false, '操作成功');
                        _this.getTableData(_this.currentIndex);
        ...
        fresh:function () {
            var _this=this;
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/wxBaseConfig/fresh.ajax',
                success: function (result) {
                    if (result.error === 0) {
                        _this.showDialog('', 'info', false, '操作成功');
                    } else {
        ...
        configMgmt:function(){
            ...
            for (var j = 0; j < this.tableData.length; j++) {
                if (this.tableData[j].check) {
                    ...
                    this.tableData[j].typeKey='wx_funcbtn';
            ...
            if(!window.localStorage){
                ...
                var url="/recommendSystem/recommendSystemConfigMgmt/positionTheThemeMgmt.html?pageType=Modify&contentTp=wx_funcbtn&channelId="+channelIds[0]
                storage.setItem("wx_funcbtn",JSON.stringify(ids));
                window.open(url);
            }
        ...
        configThis:function(item){
            ...
            if(!window.localStorage){
                ...
                var storage=window.localStorage;
                var url="/recommendSystem/recommendSystemConfigMgmt/positionTheThemeMgmt.html?pageType=Modify&contentTp=wx_funcbtn&channelId="+channelIds+'&objconfigId='+ids[0].objconfigId;
                storage.setItem("wx_funcbtn",JSON.stringify(ids));
                window.open(url);
            }
        },
