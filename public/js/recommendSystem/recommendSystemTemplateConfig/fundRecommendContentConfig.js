new Vue({
    ...
    data: {
        ...
        elementShow:{
            ...
            diaprofitAreaImgDesc: true,
            diaremark: true,
            diaimageUrl: true,
            diaprofitAreaImgUrl: true
        },
        searchChannelId:'',  //20220407新增渠道查询
    ...
    methods: {
        ...
        getOneDetail: function (objconfigId) {
            ...
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/queryInfo.ajax',
                data: params,
        ...
        getViewData: function (val,once) {
            ...
            params.contentTp = 'fund';
            val && (params.temId = val);
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/viewList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        if (result.data.rows.length > 0) {
        ...
        setAddData: function (obj) {
            ...
            this.diaprdType = obj.prdType ? obj.prdType : 1;
            ...
            this.diafundTags = obj.fundTags ? obj.fundTags : '';
            this.diaurl = obj.url ? obj.url : '';
            this.diaimageCacheFlag = obj.imageCacheFlag ? obj.imageCacheFlag : '0';
            this.diaprofitAreaImgDesc = obj.profitAreaImgDesc ? obj.profitAreaImgDesc : '';
        ...
        add: function () {
            ...
            // }
            if(this.diafundId==''){
                this.showDialog('add', 'info', true, '产品ID必须填写！');
                return;
            }
            var _this = this;
            var params = {};
            ...
            params.fundTags = this.diafundTags;
            params.url = this.diaurl;
			params.imageCacheFlag = this.diaimageCacheFlag;
            params.profitAreaImgDesc = this.diaprofitAreaImgDesc;
            ...
            var url = '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/';
        ...
        uploadPic1: function () {
            ...
            var _this = this;
            $.ajaxFileUpload({
                url: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/upload1.ajax',
                type: 'POST',
                dataType: 'json',
        ...
        uploadPic2: function () {
            ...
            var _this = this;
            $.ajaxFileUpload({
                url: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/upload2.ajax',
                type: 'POST',
                dataType: 'json',
        ...
        deleteConfirm: function () {
            var _this = this;
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/delete.ajax',
        ...
        fresh: function () {
            var _this = this;
            $.post({
                url: '/recommendSystem/recommendSystemTemplateConfig/fundRecommendContentConfig/fresh.ajax',
                success: function (result) {
                    if (result.error === 0) {
                        _this.showDialog('', 'info', false, '操作成功');
                    } else {
        ...
        configMgmt:function(){
            ...
            if(!window.localStorage){
                ...
                var url="/recommendSystem/recommendSystemConfigMgmt/positionTheThemeMgmt.html?pageType=Modify&contentTp=fund&channelId="+channelIds[0]
                storage.setItem("fund",JSON.stringify(ids));
                window.open(url);
            }
        },
        configThis:function(item){
            ...
            if(!window.localStorage){
                ...
                var storage=window.localStorage;
                var url="/recommendSystem/recommendSystemConfigMgmt/positionTheThemeMgmt.html?pageType=Modify&contentTp=fund&channelId="+channelIds+'&objconfigId='+ids[0].objconfigId;
                storage.setItem("fund",JSON.stringify(ids));
                window.open(url);
            }
        },
