new Vue({
    ...
    methods: {
        ...
        showAdd: function () {
            window.location.href = '/publicConfig/appointment/appointmentMgmt.html?pageType=Operate'
        },
        goUpdate: function (item) {
            window.location.href = '/publicConfig/appointment/appointmentMgmt.html?pageType=Operate&actId=' + item.actId
        },
        changeStatus: function (item) {
            $.post({
                url: '/publicConfig/appointment/appointmentMgmt/changeStatus.ajax',
                data: {
                    id: item.id,
        ...
        deleteData: function () {
            $.post({
                url: '/publicConfig/appointment/appointmentMgmt/del.ajax',
                data: {
        ...
        goDetail: function (item) {
            window.location.href = '/publicConfig/appointment/appointmentMgmt.html?pageType=Detail&actId=' + item.actId;
        },
        //主表格分页方法
        prev: function () {
