(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $("<input/>", {type: "hidden", id: "secondHidden", name: "secondHidden"}).appendTo(secondsTab);
            ...
            $("<input/>", {type: "hidden", id: "minHidden", name: "minHidden"}).appendTo(minutesTab);
            ...
            $("<input/>", {type: "hidden", id: "yearHidden", name: "yearHidden"}).appendTo(yearlyTab);
