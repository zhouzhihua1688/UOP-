new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            params.awardPkgId = this.awardPkgId;
            params.mobileNo = this.mobileNo;
            params.inviteCode = this.inviteCode;
            params.pageNo = currentIndex + 1;
            params.pageSize = this.pageMaxNum;
            $.post({
                url: '/marketingActive/activeDataQuery/inviteCode/getList.ajax',
                data: params,
        ...
        //     console.log(item)
        //     datas.append("userfile", item.target.files[0])
        //         var oReq = new XMLHttpRequest();
        //         oReq.open("POST", "/marketingActive/largeData/aaaa/upLoad.ajax");
        //         oReq.send(datas);
        // }
    }
});