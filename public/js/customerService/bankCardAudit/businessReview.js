...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/customerService/bankCardAudit/businessReview/getList.ajax',
                data: params,
        ...
        widowsGoTo: function (appSerialId) {
            window.location.href = '/customerService/bankCardAudit/businessReview.html?pageType=review&type=review&appSerialId=' + appSerialId;
        },
        //导出excel
        exportExcel: function () {
            ...
            var url = '/customerService/bankCardAudit/businessReview/exportExcel.ajax?invnm=' + this.invnm + '&idNo=' + this.idNo + '&mobielNo=' + this.mobielNo + '&startDate=' + this.startDate + '&endDate=' + this.endDate;
