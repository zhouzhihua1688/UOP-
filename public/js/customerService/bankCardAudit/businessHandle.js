...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/customerService/bankCardAudit/businessHandle/getList.ajax',
                data: params,
        ...
        widowsGoTo: function (appSerialId) {
            window.location.href = '/customerService/bankCardAudit/businessHandle.html?pageType=review&type=handle&appSerialId=' + appSerialId;
        },
        //导出excel
        exportExcel: function () {
            ...
            var url = '/customerService/bankCardAudit/businessHandle/exportExcel.ajax?invnm=' + this.invnm + '&idNo=' + this.idNo + '&mobielNo=' + this.mobielNo + '&startDate=' + this.startDate + '&endDate=' + this.endDate;
