...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/customerService/bankCardAudit/applyRecord/getList.ajax',
                data: params,
        ...
        widowsGoTo: function (appSerialId) {
            window.location.href = '/customerService/bankCardAudit/applyRecord.html?pageType=review&type=record&appSerialId=' + appSerialId;
        },
        //导出excel
        exportExcel: function () {
            ...
            var url = '/customerService/bankCardAudit/applyRecord/exportExcel.ajax?invnm=' + this.invnm + '&idNo=' + this.idNo + '&mobielNo=' + this.mobielNo + '&appStatus=' + this.appStatus+ '&startDate=' + this.startDate + '&endDate=' + this.endDate;
