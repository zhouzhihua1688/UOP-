var vm = new Vue({
    ...
    methods: {
        search: function () {
            var _this = this;
            var params = {};
            var url = '/customerService/custAccountMgmt/accountCancel/';
        ...
        queryCustInfoByCustNo: function (item) {
            ...
            $.post({
                url: '/customerService/custAccountMgmt/accountCancel/getTableList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.tableData = [_this.simpleData(result.data)];
        ...
        deleteData: function () {
            ...
            var _this = this;
            $.post({
                url: '/customerService/custAccountMgmt/accountCancel/del.ajax',
                data: {
