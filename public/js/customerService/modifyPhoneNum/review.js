new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                ...
                success: function (result) {
                    if (result.error === 0) {
                        this.tableData = result.data.bankcards;
                        this.detailInfo = result.data.changeMobileInfo;
                        this.images = result.data.mobileFileInfo;
        ...
        getImg: function (address) {
            if (this.images.storageType === "1") {
                return '/customerService/modifyPhoneNum/businessHandle~businessReview~applyRecord/imgObs.ajax?projectId=' + this.projectId + '&container=' + this.container + '&objectName=' + address
            } else {
                return '/customerService/modifyPhoneNum/businessHandle~businessReview~applyRecord/img.ajax?fileName=' + address
            }
        }
    }
});