...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/customerService/modifyPhoneNum/businessReview/getList.ajax',
                data: params,
        ...
        widowsGoTo: function (appSerialId) {
            window.location.href = '/customerService/modifyPhoneNum/businessReview.html?pageType=review&type=review&appSerialId=' + appSerialId;
        },
        //导出excel
        exportExcel: function () {
            ...
            var url = '/customerService/modifyPhoneNum/businessReview/exportExcel.ajax?invnm=' + this.invnm + '&idNo=' + this.idNo + '&mobielNo=' + this.mobielNo + '&startDate=' + this.startDate + '&endDate=' + this.endDate;
