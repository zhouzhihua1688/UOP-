...
new Vue({
    ...
    methods: {
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/customerService/topUpOrtake/weBankWhite/getTableData.ajax',
                data: params,
        ...
        submitTips: function () {
            ...
            console.log(params)
            $.post({
                url: '/customerService/topUpOrtake/weBankWhite/submitData.ajax',
                data: params,
                traditional: true,
                success: function (result) {
                    this.tableData=[];
    ...
    filters: {
        status: function (item) {
            if (item) {
                return item.replace(/1/g, '开通').replace(/0/g, '未开通');
            }
        },
    }
});