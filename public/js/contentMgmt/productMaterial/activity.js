...
var vm = new Vue({
    ...
    mounted: function () {
        ...
        // 获取渠道
        $.post({
            url:'/contentMgmt/productMaterial/activity/getbranchList.ajax',
    ...
    methods: {
        getTagAll:function(){
           ...
           var _this=this;
            $.post({
                url:'/contentMgmt/productMaterial/activity/getTagAll.ajax',
                data:{
                    parentCategoryId:''
                },
                success: function (result) {
    ...
    // 获取基金列表
        fundList:function(){
            var _this = this;
            $.post({
                url: '/contentMgmt/productMaterial/activity/fundList.ajax',
                success: function (result) {
                    if (result.error === 0) {
...
// 获取基金经理列表 
        getManagerList: function() {
            var _this = this;
            $.post({
                url: '/contentMgmt/productMaterial/activity/getManagerList.ajax',
                success: function(result) {
                    if (result.error === 0) {
 ...
 // 主页面数据
        ...
        getTableData: function (currentIndex) {
            ...
            _this.tableData=[];
            $.post({
                url: '/contentMgmt/productMaterial/activity/getTableData.ajax',
                data: params,
                success: function (result) {
                    $(".cover").hide();
                    if (result.error === 0) {
         ...
         getThemeList:function(mediaIdList){
            ...
            console.log(params);
            $.post({
                 url: '/contentMgmt/productMaterial/activity/getThemeList.ajax',
                 data: params,
                 success: function (result) {
                     if (result.error === 0) {
        ...
        //   params.publishTime="20220421"; 
          ...
          let url='';
          if(!_this.updateId){
             url='/contentMgmt/productMaterial/activity/add.ajax'
          }else{
              params.mediaId=_this.updateId;
             url='/contentMgmt/productMaterial/activity/update.ajax'
          }
            $.post({
                url:url,
                data:params,
...
// start-现有材料相关操作--弹窗
        ...
        chooseMaterialId:function(materialId,num){
            ...
            console.log(params);
            $.post({
                url: '/contentMgmt/productMaterial/activity/threeClassifyList.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        console.log(result)
        ...
        searchMaterial:function(currentIndex){
            var _this=this;
                ...
                $.post({
                    url: '/contentMgmt/productMaterial/activity/searchMaterial.ajax',
                    data: params,
                    success: function (result) {
                        if (result.error === 0) {
                            if(currentIndex){
        ...
        // start-用mediaId调取details数据获取分类id和关联标签的回显
          ...
          console.log(params);
          $.post({
              url: '/contentMgmt/productMaterial/activity/getUpdateDetails.ajax',
              data: params,
              success: function (result) {
                  if (result.error === 0) {
...
//end-- 修改数据
        ...
        uploadForServer() {
            ...
            var _this = this;
                ...
                $.post({
                    url: '/contentMgmt/productMaterial/activity/uploadImgCover.ajax',
...
//start-删除数据
        ...
        del:function(){
            ...
            console.log(params);
            $.post({
                url: '/contentMgmt/productMaterial/activity/del.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        setTimeout(function(){
...
//end-删除数据
    ...
    //    一级标签
        getTagList:function(){
            ...
            var params={}
            $.post({
                url:'/contentMgmt/productMaterial/activity/getTagList.ajax',
                // data:params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        getSecondTagList:function(tagCategoryId,i){
            ...
            console.log(params);
            $.post({
                url:'/contentMgmt/productMaterial/activity/getSecondTagList.ajax',
                data:params,
                success: function (result) {
                    if (result.error === 0) {
                        console.log(result);
        ...
        uploadsFile(e) {
            ...
            $(".cover").show();
            $.post({
                url: '/contentMgmt/productMaterial/activity/uploadFile.ajax',
                type: 'post',
                dataType: 'json',
                data: formdata,
                processData: false,
        ...
        uploadImg:function(e){
            ...
            var reader = new FileReader()
                ...
                reader.onload = (e) => {
                    ...
                    $.post({
                        url: '/contentMgmt/productMaterial/activity/uploadImg.ajax',
                        // data: res.compressBase64,
                        cache: false,
                        data: formdata,
                        processData: false,
