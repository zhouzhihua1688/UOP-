    ...
    mounted: function () {
        ...
        $.post({
            ...
            success: function (result) {
                if (result.error === 0) {
                    _this.categoryIdList=result.data.body.ncmsContentCategoryConfigList;
                    for(var i=0;i< _this.categoryIdList.length;i++){
                        if( _this.jumpParentCategoryId==_this.categoryIdList[i].categoryId){
                            _this.searchId=_this.categoryIdList[i].categoryId;
                        }
                    }
                }else {
    ...
    methods: {
        ...
        changeIdList:function(id){
            ...
            $.post({
                ...
                success: function (result) {
                    if (result.error === 0) {
                        _this.seondCategoryIdList=result.data.body.ncmsContentCategoryConfigList;
                        _this.addSeondCategoryIdList=result.data.body.ncmsContentCategoryConfigList;
