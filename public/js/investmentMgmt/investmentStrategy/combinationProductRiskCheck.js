new Vue({
    ...
    methods: {
        ...
        getTableData: function (currentIndex) {
            ...
            $.post({
                url: '/investmentMgmt/investmentStrategy/combinationProductRiskCheck/getTableData.ajax',
                data: params,
        ...
        reviewRisk:function(item){
            ...
            console.log(params);
            $.post({
                url: '/investmentMgmt/investmentStrategy/combinationProductRiskCheck/reviewRisk.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
        ...
        checkRisk:function(item){
            ...
            console.log(params);
            $.post({
                url: '/investmentMgmt/investmentStrategy/combinationProductRiskCheck/checkRisk.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0);
        ...
        rejectRisk:function(item){
            ...
            $.post({
                url: '/investmentMgmt/investmentStrategy/combinationProductRiskCheck/rejectRisk.ajax',
                data: params,
                success: function (result) {
                    if (result.error === 0) {
                        _this.getTableData(0);
